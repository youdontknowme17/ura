...
public:
	...
	afx_msg void OnEnChangeEditSumtime4();

	//Add Multi Special Effect 
	afx_msg void OnBnClickedButtonSpecialEffectPrev();
	afx_msg void OnBnClickedButtonSpecialEffectNext();
	
	afx_msg void OnBnClickedButtonSpecialEffectLevelPrev();
	afx_msg void OnBnClickedButtonSpecialEffectLevelNext();

	void	UpdateSpecialEffect();
	void	InverseUpdateSpecialEffect ();

	DWORD	m_dwSpecialEffectLvl;
	DWORD	m_dwSpecialEffectLvl2;
	
	//Add Multi Side Effect 
	afx_msg void OnBnClickedButtonSideEffectPrev();
	afx_msg void OnBnClickedButtonSideEffectNext();
	
	afx_msg void OnBnClickedButtonSideEffectLevelPrev();
	afx_msg void OnBnClickedButtonSideEffectLevelNext();

	void	UpdateSideEffect();
	void	InverseUpdateSideEffect ();

	DWORD	m_dwSideEffectLvl;
	DWORD	m_dwSideEffectLvl2;
};
