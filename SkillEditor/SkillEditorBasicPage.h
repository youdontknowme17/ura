...
public:
	...
	afx_msg void OnEnChangeEditBrange();

	//Add Multi Special Effect 
	afx_msg void OnBnClickedButtonINCLevel();
	afx_msg void OnBnClickedButtonDECLevel();
	...
	afx_msg void OnBnClickedButtonINCLevel_SideEffect();
	afx_msg void OnBnClickedButtonDECLevel_SideEffect();

	void UpdateSideEffect();
	void InverseSideEffect();

	DWORD m_dwSideEffect;
};
