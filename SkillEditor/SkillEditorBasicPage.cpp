...
BEGIN_MESSAGE_MAP(SkillEditorBasicPage, CPropertyPage)
	...
	ON_EN_CHANGE(IDC_EDIT_BRANGE, OnEnChangeEditBrange)

	//Add Multi Special Effect 
	ON_BN_CLICKED(IDC_BUTTON_SKILLEFFECT_INC, OnBnClickedButtonINCLevel)
	ON_BN_CLICKED(IDC_BUTTON_SKILLEFFECT_DEC, OnBnClickedButtonDECLevel)
	ON_BN_CLICKED(IDC_BUTTON_SIDEEFFECT_INC, OnBnClickedButtonINCLevel_SideEffect)
	ON_BN_CLICKED(IDC_BUTTON_SIDEEFFECT_DEC, OnBnClickedButtonDECLevel_SideEffect)
END_MESSAGE_MAP()
...
void SkillEditorBasicPage::InitDefaultCtrls ()
{
	...
	SetWin_Combo_Init ( this, IDC_COMBO_EMACTION, COMMENT::EMACTION, SKILL::EMSTIGMA_SIZE );
	...
	//Add Multi Special Effect 
	SetWin_Combo_Init ( this, IDC_COMBO_SKILLEFFECT, COMMENT::SPEC_ADDON, EMSPECA_NSIZE );
	SetWin_Combo_Init ( this, IDC_COMBO_SIDEEFFECT, COMMENT::IMPACT_ADDON, EIMPACTA_SIZE );
;
	...
	SetWin_Combo_Init ( this, IDC_COMBO_TAR03, COMMENT::SKILL_EFFTIME, SKILL::EMTIME_NSIZE );
	...
	SetWin_Combo_Init ( this, IDC_COMBO_SELF3, COMMENT::SKILL_EFFTIME, SKILL::EMTIME_NSIZE );
	...
	SetWin_Combo_Init ( this, IDC_COMBO_TARP03, COMMENT::SKILL_EFFPOS, SKILL::EMPOS_NSIZE );
	...
	SetWin_Combo_Init ( this, IDC_COMBO_SELFP3, COMMENT::SKILL_EFFPOS, SKILL::EMPOS_NSIZE );
...
//	SetWin_Combo_Sel ( this, IDC_COMBO_EMSPEC, (int)m_pDummySkill->m_sAPPLY.emSPEC );
	...
	//Extreme Reboot 
	SetWin_Num_int ( this, IDC_EDIT_REQWEAPON_MID, m_pDummySkill->m_sLEARN.sWEAPON.wMainID );
	SetWin_Num_int ( this, IDC_EDIT_REQWEAPON_SID, m_pDummySkill->m_sLEARN.sWEAPON.wSubID );
...
//	m_pDummySkill->m_sLEARN.sLINK.wMainID = GetWin_Num_int ( this, IDC_EDIT_REQSKILLMID2 );
//	m_pDummySkill->m_sLEARN.sLINK.wSubID = GetWin_Num_int (this, IDC_EDIT_REQSKILLSID2 );

	//Extreme Reboot 
	m_pDummySkill->m_sLEARN.sWEAPON.wMainID = GetWin_Num_int ( this, IDC_EDIT_REQWEAPON_MID );
	m_pDummySkill->m_sLEARN.sWEAPON.wSubID = GetWin_Num_int ( this, IDC_EDIT_REQWEAPON_SID ); 
...
void SkillEditorBasicPage::UpdateSkillSExtData (DWORD dwType)
{
	...
	SetWin_Combo_Sel ( this, IDC_COMBO_SELF3, (int)m_pDummySkill->m_sEXT_DATA.emSELFZONE03 );
	SetWin_Combo_Sel ( this, IDC_COMBO_SELFP3, (int)m_pDummySkill->m_sEXT_DATA.emSELFZONE03_POS );
	SetWin_Text ( this, IDC_EDIT_SELF3, m_pDummySkill->m_sEXT_DATA.strSELFZONE03[dwType].c_str() );
	...
	SetWin_Combo_Sel ( this, IDC_COMBO_TAR03, (int)m_pDummySkill->m_sEXT_DATA.emTARGZONE03 );
	SetWin_Combo_Sel ( this, IDC_COMBO_TARP03, (int)m_pDummySkill->m_sEXT_DATA.emTARGZONE03_POS );
	SetWin_Text ( this, IDC_EDIT_TAR03, m_pDummySkill->m_sEXT_DATA.strTARGZONE03[dwType].c_str() );
	...
	SetWin_Num_int ( this, IDC_EDIT_ADDSKILL_MID, m_pDummySkill->m_sEXT_DATA.sADDSKILL.wMainID );
	SetWin_Num_int ( this, IDC_EDIT_ADDSKILL_SID, m_pDummySkill->m_sEXT_DATA.sADDSKILL.wSubID );

	SetWin_Num_int ( this, IDC_EDIT_ADDSKILLLEVEL, m_pDummySkill->m_sEXT_DATA.dwADDSKILLLEVEL );
}
...
BOOL  SkillEditorBasicPage::InverseUpdateSkillSExtData (DWORD dwType)
{
	...
	m_pDummySkill->m_sEXT_DATA.emSELFZONE03 = (SKILL::EMEFFECTIME) GetWin_Combo_Sel ( this, IDC_COMBO_SELF3 );
	m_pDummySkill->m_sEXT_DATA.emSELFZONE03_POS = (SKILL::EMEFFECTPOS) GetWin_Combo_Sel ( this, IDC_COMBO_SELFP3);
	m_pDummySkill->m_sEXT_DATA.strSELFZONE03[dwType] = GetWin_Text( this, IDC_EDIT_SELF3 );
	...
	m_pDummySkill->m_sEXT_DATA.emTARGZONE03 = (SKILL::EMEFFECTIME) GetWin_Combo_Sel ( this, IDC_COMBO_TAR03 );
	m_pDummySkill->m_sEXT_DATA.emTARGZONE03_POS = (SKILL::EMEFFECTPOS) GetWin_Combo_Sel ( this, IDC_COMBO_TARP03);
	m_pDummySkill->m_sEXT_DATA.strTARGZONE03[dwType] = GetWin_Text( this, IDC_EDIT_TAR03 );
	...
	m_pDummySkill->m_sEXT_DATA.sADDSKILL.wMainID =  GetWin_Num_int ( this, IDC_EDIT_ADDSKILL_MID );
	m_pDummySkill->m_sEXT_DATA.sADDSKILL.wSubID =  GetWin_Num_int ( this, IDC_EDIT_ADDSKILL_SID );

	m_pDummySkill->m_sEXT_DATA.dwADDSKILLLEVEL =  GetWin_Num_int ( this, IDC_EDIT_ADDSKILLLEVEL );
	return TRUE;
}
...
void SkillEditorBasicPage::OnEnChangeEditPrice()
{
...
void SkillEditorBasicPage::OnEnChangeEditBrange()
{
	// TODO:  If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CPropertyPage::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void SkillEditorBasicPage::OnBnClickedButtonINCLevel()
{
	InverseUpdateSpecialEffect();
	m_dwSpecialEffect++;
	if ( m_dwSpecialEffect >= SKILL::MAX_LEVEL ) m_dwSpecialEffect--;
	UpdateSpecialEffect();
}

void SkillEditorBasicPage::OnBnClickedButtonDECLevel()
{
	InverseUpdateSpecialEffect();
	if ( m_dwSpecialEffect <= 0 ) return;
	m_dwSpecialEffect--;
	UpdateSpecialEffect();
}

void SkillEditorBasicPage::UpdateSpecialEffect()
{
	SetWin_Combo_Sel ( this, IDC_COMBO_SKILLEFFECT, (int)m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffect].emSPEC );
}

void SkillEditorBasicPage::InverseUpdateSpecialEffect()
{
	m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffect].emSPEC = (EMSPEC_ADDON) GetWin_Combo_Sel ( this, IDC_COMBO_SKILLEFFECT);
}

//Add Multi Side Effect 
void SkillEditorBasicPage::OnBnClickedButtonINCLevel_SideEffect()
{
	InverseSideEffect();
	m_dwSideEffect++;
	if ( m_dwSideEffect >= SKILL::MAX_LEVEL ) m_dwSideEffect--;
	UpdateSideEffect();
}

void SkillEditorBasicPage::OnBnClickedButtonDECLevel_SideEffect()
{
	InverseSideEffect();
	if ( m_dwSideEffect <= 0 ) return;
	m_dwSideEffect--;
	UpdateSideEffect();
}

void SkillEditorBasicPage::UpdateSideEffect()
{
	SetWin_Combo_Sel ( this, IDC_COMBO_SIDEEFFECT, (int)m_pDummySkill->m_sAPPLY.sADDONS[m_dwSideEffect].emADDON );
}

void SkillEditorBasicPage::InverseSideEffect()
{
	m_pDummySkill->m_sAPPLY.sADDONS[m_dwSideEffect].emADDON = (EMIMPACT_ADDON) GetWin_Combo_Sel ( this, IDC_COMBO_SIDEEFFECT);
}