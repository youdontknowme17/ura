...
BEGIN_MESSAGE_MAP(SkillEditorLevelPage, CPropertyPage)
	...
	//Add Multi Special Effect 
	ON_BN_CLICKED(IDC_BUTTON_EMSPEC_SKILL_DOWN, OnBnClickedButtonSpecialEffectPrev)
	ON_BN_CLICKED(IDC_BUTTON_EMSPEC_SKILL_UP, OnBnClickedButtonSpecialEffectNext)
	ON_BN_CLICKED(IDC_BUTTON_EMSPEC_SKILL_LEVEL_DOWN, OnBnClickedButtonSpecialEffectLevelPrev)
	ON_BN_CLICKED(IDC_BUTTON_EMSPEC_SKILL_LEVEL_UP, OnBnClickedButtonSpecialEffectLevelNext)
	
	//Add Multi Side Effect 
	ON_BN_CLICKED(IDC_BUTTON_SIDEEFFECT_PREV, OnBnClickedButtonSideEffectPrev)
	ON_BN_CLICKED(IDC_BUTTON_SIDEEFFECT_NEXT, OnBnClickedButtonSideEffectNext)
	ON_BN_CLICKED(IDC_BUTTON_SIDEEFFECT_DECREASE, OnBnClickedButtonSideEffectLevelPrev)
	ON_BN_CLICKED(IDC_BUTTON_SIDEEFFECT_INCREASE, OnBnClickedButtonSideEffectLevelNext)
END_MESSAGE_MAP()
...
void SkillEditorLevelPage::InitDefaultCtrls ()
{
	...
	m_dwSkillLevel = 0;
	//Add Multi Special Effect 
	m_dwSpecialEffectLvl = 0;
	m_dwSpecialEffectLvl2 = 0;

	//Add Multi Special Effect 
	m_dwSideEffectLvl = 0;
	m_dwSideEffectLvl2 = 0;
	
	InverseUpdateSideEffect();
	InverseUpdateSpecialEffect();
...
//Add Multi Special Effect 
void SkillEditorLevelPage::OnBnClickedButtonSpecialEffectPrev()
{
	InverseUpdateSpecialEffect();
	if ( m_dwSpecialEffectLvl <= 0 ) return ;
	m_dwSpecialEffectLvl--;
	UpdateSpecialEffect();
}

void SkillEditorLevelPage::OnBnClickedButtonSpecialEffectNext()
{
	InverseUpdateSpecialEffect();
	m_dwSpecialEffectLvl++;
	if ( m_dwSpecialEffectLvl >= SKILL::MAX_LEVEL ) m_dwSpecialEffectLvl--;
	UpdateSpecialEffect();
}

void SkillEditorLevelPage::OnBnClickedButtonSpecialEffectLevelPrev()
{
	InverseUpdateSpecialEffect();
	if ( m_dwSpecialEffectLvl2 <= 0 ) return ;
	m_dwSpecialEffectLvl2--;
	UpdateSpecialEffect();
}

void SkillEditorLevelPage::OnBnClickedButtonSpecialEffectLevelNext()
{
	InverseUpdateSpecialEffect();
	m_dwSpecialEffectLvl2++;
	if ( m_dwSpecialEffectLvl2 >= SKILL::MAX_LEVEL ) m_dwSpecialEffectLvl2--;
	UpdateSpecialEffect();
}

void SkillEditorLevelPage::UpdateSpecialEffect()
{
	CString strTemp;
	strTemp.Format( "%d", m_dwSpecialEffectLvl);
	SetWin_Text( this, IDC_EDIT_EMSPEC_SPECIAL_NAME, strTemp.GetString());
	
	strTemp.Format( "%d", m_dwSpecialEffectLvl2);
	SetWin_Text( this, IDC_EDIT_EMSPEC_EFFECT_LEVEL, strTemp.GetString());

	strTemp.Format( "Special Effect: %s" , COMMENT::SPEC_ADDON[m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].emSPEC].c_str() );
	SetWin_Text( this ,IDC_STATIC_SPA , strTemp.GetString() );
	
	strTemp.Format( "%s" , COMMENT::SPEC_ADDON_VAR1[m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].emSPEC].c_str() );
	SetWin_Text( this ,IDC_STATIC_SPVAR1 , strTemp.GetString() );

	strTemp.Format( "%s" , COMMENT::SPEC_ADDON_VAR2[m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].emSPEC].c_str() );
	SetWin_Text( this ,IDC_STATIC_SPVAR2 , strTemp.GetString() );
	
	SetWin_Num_float ( this, IDC_EDIT_SPVAR1, m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].fVAR1 );
	SetWin_Num_float ( this, IDC_EDIT_SPVAR2, m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].fVAR2 );
	
//	SetWin_Num_float ( this, IDC_EDIT_LINK_MID_I, m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].dwNativeID.wMainID );
//	SetWin_Num_float ( this, IDC_EDIT_LINK_SID_I, m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].dwNativeID.wSubID );
//	SetWin_Num_float ( this, IDC_EDIT_LINK_MID_II, m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].dwNativeID2.wMainID );
//	SetWin_Num_float ( this, IDC_EDIT_LINK_SID_II, m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].dwNativeID2.wSubID );
}

void SkillEditorLevelPage::InverseUpdateSpecialEffect()
{
	m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].fVAR1 = GetWin_Num_float ( this, IDC_EDIT_SPVAR1 );
	m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].fVAR2 = GetWin_Num_float ( this, IDC_EDIT_SPVAR2 );
	
//	m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].dwNativeID.wMainID = GetWin_Num_float ( this, IDC_EDIT_LINK_MID_I );
//	m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].dwNativeID.wSubID = GetWin_Num_float ( this, IDC_EDIT_LINK_SID_I );
//	m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].dwNativeID2.wMainID = GetWin_Num_float ( this, IDC_EDIT_LINK_MID_II );
//	m_pDummySkill->m_sAPPLY.sSPECS[m_dwSpecialEffectLvl].sSPEC[m_dwSpecialEffectLvl2].dwNativeID2.wSubID = GetWin_Num_float ( this, IDC_EDIT_LINK_SID_II );
}

//Add Multi Side Effect 
void SkillEditorLevelPage::OnBnClickedButtonSideEffectPrev()
{
	InverseUpdateSideEffect();
	if ( m_dwSideEffectLvl <= 0 ) return ;
	m_dwSideEffectLvl--;
	UpdateSideEffect();
}

void SkillEditorLevelPage::OnBnClickedButtonSideEffectNext()
{
	InverseUpdateSideEffect();
	m_dwSideEffectLvl++;
	if ( m_dwSideEffectLvl >= SKILL::MAX_LEVEL ) m_dwSideEffectLvl--;
	UpdateSideEffect();
}

void SkillEditorLevelPage::OnBnClickedButtonSideEffectLevelPrev()
{
	InverseUpdateSideEffect();
	if ( m_dwSideEffectLvl2 <= 0 ) return ;
	m_dwSideEffectLvl2--;
	UpdateSideEffect();
}

void SkillEditorLevelPage::OnBnClickedButtonSideEffectLevelNext()
{
	InverseUpdateSideEffect();
	m_dwSideEffectLvl2++;
	if ( m_dwSideEffectLvl2 >= SKILL::MAX_LEVEL ) m_dwSideEffectLvl2--;
	UpdateSideEffect();
}

void SkillEditorLevelPage::UpdateSideEffect()
{
	CString strTemp;

	strTemp.Format( "Side Effect : %s" , COMMENT::IMPACT_ADDON[m_pDummySkill->m_sAPPLY.sADDONS[m_dwSideEffectLvl].emADDON].c_str() );
	SetWin_Text( this ,IDC_STATIC_SDE , strTemp.GetString() );
	
	strTemp.Format( "%d", m_dwSideEffectLvl2);
	SetWin_Text( this, IDC_EDIT_SIDEEFFECT_LEVEL, strTemp.GetString());

	SetWin_Num_float ( this, IDC_EDIT_ADDONVAR, m_pDummySkill->m_sAPPLY.sADDONS[m_dwSideEffectLvl].fADDON_VAR[m_dwSideEffectLvl2]);
}

void SkillEditorLevelPage::InverseUpdateSideEffect()
{
	m_pDummySkill->m_sAPPLY.sADDONS[m_dwSideEffectLvl].fADDON_VAR[m_dwSideEffectLvl2] = GetWin_Num_float ( this, IDC_EDIT_ADDONVAR );
}
void SkillEditorLevelPage::UpdateSkill( DWORD	m_dwSkillLevel )
{
	...
	SetWin_Num_int ( this, IDC_EDIT_RPOW, m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwPow );
	SetWin_Num_int ( this, IDC_EDIT_RSPR, m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwSpi );
	SetWin_Num_int ( this, IDC_EDIT_RINT, m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwInt );
	SetWin_Num_int ( this, IDC_EDIT_RSTR, m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwStr );
	SetWin_Num_int ( this, IDC_EDIT_RDEX, m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwDex);
	SetWin_Num_int ( this, IDC_EDIT_RSTA, m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwSta);
...
//	SetWin_Num_int ( this, IDC_EDIT_SUMTIME, m_pDummySkill->m_sSPECIAL_SKILL.dwSummonTime );
	...
	SetWin_Num_float ( this, IDC_EDIT_VAR1, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].fSummon);
	SetWin_Num_float ( this, IDC_EDIT_VAR2, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].fSummon1);
	SetWin_Num_int ( this, IDC_EDIT_VAR3, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].dwSummon);
	SetWin_Num_int ( this, IDC_EDIT_VAR4, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].wSummon1);
	SetWin_Num_int ( this, IDC_EDIT_VAR5, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].bSummon);
	SetWin_Num_int ( this, IDC_EDIT_VAR6, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].dwSummon1);
...
BOOL SkillEditorLevelPage::InverseUpdateSkill( DWORD	m_dwSkillLevel )
{
	...
	m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwPow = GetWin_Num_int ( this, IDC_EDIT_RPOW ); 
	m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwSpi = GetWin_Num_int ( this, IDC_EDIT_RSPR ); 
	m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwInt = GetWin_Num_int ( this, IDC_EDIT_RINT ); 
	m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwStr = GetWin_Num_int ( this, IDC_EDIT_RSTR ); 
	m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwDex = GetWin_Num_int ( this, IDC_EDIT_RDEX ); 
	m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].sSTATS.dwSta = GetWin_Num_int ( this, IDC_EDIT_RSTA ); 
...
//	m_pDummySkill->m_sSPECIAL_SKILL.dwSummonTime = GetWin_Num_int ( this, IDC_EDIT_SUMTIME );
	...
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].fSummon = GetWin_Num_float ( this, IDC_EDIT_VAR1 );
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].fSummon1 = GetWin_Num_float ( this, IDC_EDIT_VAR2 );
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].dwSummon = GetWin_Num_int ( this, IDC_EDIT_VAR3 );
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].wSummon1 = GetWin_Num_int ( this, IDC_EDIT_VAR4 );
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].bSummon = GetWin_Num_int ( this, IDC_EDIT_VAR5 ) != 0 ? true : false;
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[ m_dwSkillLevel ].dwSummon1 = GetWin_Num_int ( this, IDC_EDIT_VAR6 );
...
void SkillEditorLevelPage::OnEnChangeEditSumtime4()
{
