...
{	
	...
	for ( int i = nPartIndex; i < nPartSize; ++i )
	{
		...
		for ( int j = nLineIndex; j < nLineCount; ++j )
		{
			...
			if ( m_nAlign & TEXT_ALIGN_BOTH_X && 1 < vectorTextWord.size() && !m_bChat )
			{
				long lGAP = 0;
				long OneGap = 0;
...
//MARCK-WORKS
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CString	CBasicTextBox::CalcText( CString strWhole, int nStrPos, int nSize )
{
	CString strTemp;
	for(int i = ( nStrPos - 1 ) ; i < nSize ; i++)
	{
		strTemp = strWhole[i];
	}
	return strTemp;
