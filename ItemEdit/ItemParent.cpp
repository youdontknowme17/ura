...
/*	SetWin_Num_int ( this, IDC_EDIT_DWDUMMY1, m_pDummyItem->sBasicOp.dwDummy1 );
	...
	//add abl
	SetWin_Text ( this, IDC_EDIT_ABL_M_L, m_pDummyItem->GetCpsFile((EMCPSINDEX)0) ); // 격투남 	
	SetWin_Text ( this, IDC_EDIT_ABL_M_R, m_pDummyItem->GetCpsFile((EMCPSINDEX)1) ); // 격투여
	SetWin_Text ( this, IDC_EDIT_ABL_W_L, m_pDummyItem->GetCpsFile((EMCPSINDEX)2) ); // 검도남
	SetWin_Text ( this, IDC_EDIT_ABL_W_R, m_pDummyItem->GetCpsFile((EMCPSINDEX)3) ); // 검도여

	SetWin_Text ( this, IDC_EDIT_VEHICLEPART, m_pDummyItem->sBasicOp.strVPSFile.c_str()) ; // 검도여
