...
BEGIN_MESSAGE_MAP(CRanManagerCharPutOn, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_BUTTON_P_19, OnBnClickedButtonP19)
...
void CRanManagerCharPutOn::ShowPutOn ()
{
	...
	for ( int i = 0; i < SLOT_NSIZE_S_2; i++ )
	{
		...
		case 19:	SetWin_Text(this,IDC_BUTTON_P_19,szTemp);
		};
	}
...
void CRanManagerCharPutOn::OnBnClickedButtonP19()	{	SelectSlot(19);	SetPutOnItemState ( this,IDC_BUTTON_P_19 );	}
...
void CRanManagerCharPutOn::SetPutOnItemState ( CDialog *pDlg,int nID )
{
	...
	case IDC_BUTTON_P_19:	pBtn =  (CButton*)pDlg->GetDlgItem ( IDC_BUTTON_P_19 );	pBtn->SetState(TRUE);	break;
	};
}
...
void CRanManagerCharPutOn::ResetPutOnItemState ( CDialog *pDlg )
{
	...
	pBtn =  (CButton*)pDlg->GetDlgItem ( IDC_BUTTON_P_19 );	pBtn->SetState(FALSE);
}
