...
void	CRanManagerVehicleEdit::GetVehicle(int nVehicleNum)
{
	...
	_snprintf( szTemp, 1024, 
		"SELECT VehicleNum,VehicleName,VehicleChaNum,VehicleType,VehicleCardMID,VehicleCardSID,VehicleBattery,VehicleDeleted,VehicleCreateDate,VehicleDeletedDate,VehicleColor"
...
void CRanManagerVehicleEdit::OnBnClickedBtnEditSave()
{
	...
	_snprintf( szTemp, 1024, "UPDATE %s.dbo.VehicleInfo SET VehicleName='%s' ,VehicleChaNum=%u, VehicleType=%u, "
				"VehicleCardMID=%u, VehicleCardSID=%u, VehicleBattery=%u, VehicleDeleted=%d, VehicleCreateDate='%s',VehicleDeletedDate='%s' ,VehicleColor=%u "
				"WHERE VehicleNum=%u", 
