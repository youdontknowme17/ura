...
BOOL CItemSearch::Search_1()
{
	...
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_ASSASIN_M ), dwFlag, GLCC_ASSASIN_M ); 
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_ASSASIN_W ), dwFlag, GLCC_ASSASIN_W ); 
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TESTING_M ), dwFlag, GLCC_TESTING_M ); 
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TESTING_W ), dwFlag, GLCC_TESTING_W ); 
...
BOOL CItemSearch::Search_2()
{
	...
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_ASSASIN_M2 ), dwFlag, GLCC_ASSASIN_M ); 
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_ASSASIN_W2 ), dwFlag, GLCC_ASSASIN_W ); 
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TESTING_M2 ), dwFlag, GLCC_TESTING_M ); 
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TESTING_W2 ), dwFlag, GLCC_TESTING_W ); 
