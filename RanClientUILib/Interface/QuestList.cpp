...
{
	m_pButtonMenuL = CreateTextButton23 ( "QUEST_LIST_BUTTON_L", QUEST_LIST_BUTTON_L, (char*)ID2GAMEWORD("QUEST_LIST_BUTTON",0) );
	m_pButtonMenuL->SetFlipYellow ( FALSE );
	m_pButtonMenuR = CreateTextButton23 ( "QUEST_LIST_BUTTON_R", QUEST_LIST_BUTTON_R, (char*)ID2GAMEWORD("QUEST_LIST_BUTTON",1) );	
	m_pButtonMenuR->SetFlipYellow ( FALSE );
...
{
	m_pButtonMenuL->SetFlipYellow ( bProg );
	m_pButtonMenuR->SetFlipYellow ( !bProg );
...
CBasicTextButton* CQuestList::CreateTextButton14 ( char* szButton, UIGUID ControlID , char* szText )
{
	...
	pButton->CreateBaseButton ( szButton, nBUTTONSIZE, CBasicButton::CLICK_FLIP, szText, _DEFAULT_FONT_FLAG );
...
CBasicTextButton* CQuestList::CreateTextButton19 ( char* szButton, UIGUID ControlID , char* szText )
{
	...
	pButton->CreateBaseButton ( szButton, nBUTTONSIZE, CBasicButton::RADIO_FLIP, szText, _DEFAULT_FONT_FLAG );
	RegisterControl ( pButton );
	return pButton;
}

CBasicTextButton* CQuestList::CreateTextButton22 ( char* szButton, UIGUID ControlID , char* szText )
{
...
CBasicTextButton* CQuestList::CreateTextButton23 ( char* szButton, UIGUID ControlID , char* szText )
{
