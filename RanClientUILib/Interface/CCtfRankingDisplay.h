...
private:
	...
	CCtfRankingPage*		m_pCtfRankingPage[nMAXPAGE];
	CCtfRankingPage*		m_pCtfMyRankingPage;

	CCtfRankingPage*		CreateRankPage ( UIGUID ControlID, bool bMyRank );
