...
EMSLOT CInventoryPageWearView::IMAGE2EMSLOT ( int nIndex )
{
	...
	case ITEM_IMAGE15:	return SLOT_LEARRING;
	case ITEM_IMAGE16:	return SLOT_LACCESSORY;
	case ITEM_IMAGE17:	return SLOT_REARRING;
	case ITEM_IMAGE18:	return SLOT_RACCESSORY;
	}
...
void CInventoryPageWearView::CreateNumberBox ()
{
	{	//	πÿπŸ¥⁄ πË∞Ê
		CString strInvenWearItem[ITEM_IMAGE_SIZE] = 
		{
			...
			//"CHARACTER_WINDOW_WEAR_SLOTVIEW_EX_FIRST_RIGHT_WEAPON_TEXT",
			//"CHARACTER_WINDOW_WEAR_SLOTVIEW_EX_SECOND_RIGHT_WEAPON_TEXT",
			...
			//"CHARACTER_WINDOW_WEAR_SLOTVIEW_EX_FIRST_LEFT_WEAPON_TEXT",
			//"CHARACTER_WINDOW_WEAR_SLOTVIEW_EX_SECOND_LEFT_WEAPON_TEXT",
			//"CHARACTER_WINDOW_WEAR_SLOTVIEW_VEHICLE_TEXT",
