...
void CKeySettingWindow::CreateSubControl()
{
	...
	pDefaultButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, KEYSETTING_DEFAULTSETTING );
	...
	pApplyButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, KEYSETTING_APPLY );
	...
	pOKButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, KEYSETTING_OK );
