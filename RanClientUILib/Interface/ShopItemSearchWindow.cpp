	...
	if( m_pItemNameEdit->GetEditLength( ITEMSHOPSEARCH_EDIT ) != 0 )
	{
		...
		if( nIndex != 0 && nIndex != -1 )
		{
			...
			case 5:
				...
				break;
				case 6:
				NetMsg.sSearchData.dwReqCharClass = GLCC_SCIENCE_M;
				break;
				case 7:
				NetMsg.sSearchData.dwReqCharClass = GLCC_ASSASIN_M;
				break;
				case 8:
				NetMsg.sSearchData.dwReqCharClass = GLCC_TESTING_M;
				break;
				case 9:
				NetMsg.sSearchData.dwReqCharClass = GLCC_SHAPER_M;
				break;
			}
		}
		// 아이템 타입
		...
		if( nIndex != 0 && nIndex != -1 )
		{
			...
			case 8: // 투척
				...
				//
				case 9: // 투척
				NetMsg.sSearchData.dwSuitType = ITEMATT_DUAL_GUN;
				break;
				case 10: // 투척
				...
				break;
				case 13: // 투척
				NetMsg.sSearchData.dwSuitType = ITEMATT_SHURIKEN;
				break;
				case 14: // 투척
				NetMsg.sSearchData.dwSuitType = ITEMATT_SCYTHE;
				break;
			}
		}
		// 착용 레벨
		...
		if( nIndex != 0 && nIndex != -1  )
		{
			...
			{
			case 1:
				NetMsg.sSearchData.sReqStats.dwDex = 1;
				break;
			case 2:
				NetMsg.sSearchData.sReqStats.dwPow = 1;
				break;
			case 3:
				NetMsg.sSearchData.sReqStats.dwSpi = 1;
				break;
			}
		}
