...
void CPartySlot::CreateSubControl ()
{
	...
	CString strClassLive[GLCI_NUM_2015] =
	{
		...
		//added by CNDev
		"PARTY_INFO_SHAPER_MALE_LIVE",
		"PARTY_INFO_SHAPER_FEMALE_LIVE",
	};

	CString strClassDie[GLCI_NUM_2015] =
	{
		...
		//added by CNDev
		"PARTY_INFO_SHAPER_MALE_DIE",
		"PARTY_INFO_SHAPER_FEMALE_DIE",
	};
...
{
	if ( nClass < GLCI_FIGHTER_M && nClass > GLCI_SHAPER_W ) return;
