...
CBasicTextButton*	 CSelectServerPage::CreateTextButton ( char* szButton, UIGUID ControlID, char* szText )
{
...
//		CreateControl ( "TRANG_CHON_MAYCHU_DANHSACH_BG" );
	...
	{
#ifdef CH_PARAM
		CreateTextButton ( "SELECT_CHINA_AREA_BACK", SELECT_CHINA_AREA_BACK, (char*)ID2GAMEWORD( "SELECT_CHINA_AREA" ) );
...
/*		CBasicTextButton* pButton = new CBasicTextButton;
		...
		m_pSelectServerChannel->CreateSubEx ( this, "CUASO_NGOAI", SELECT_SERVER_CHANNEL );
		m_pSelectServerChannel->CreateBaseWidnow ( "TRANG_CHON_MAYCHU", (char*) ID2GAMEWORD ( "SELECT_SERVER" ) );			
	...
	{
		CreateTextButton ( "SELECT_SERVER_CONNECT", SELECT_SERVER_CONNECT, (char*)ID2GAMEWORD ( "SELECT_SERVER_CONNECTQUIT", 0 ) );
...
/*		CBasicTextButton* pOKButton = new CBasicTextButton;
	...
	CreateTextButton ( "SELECT_SERVER_QUIT", SELECT_SERVER_QUIT, (char*)ID2GAMEWORD( "SELECT_SERVER_CONNECTQUIT", 1 ) );
...
void	CSelectServerPage::Login ()
{
	...
	{
		COuterInterface::GetInstance().ToSelectMenuPage ( GetWndID () );
	}
}
