...
{	
	...
	AddStringToNORMAL ( strCombine2, NS_UITEXTCOLOR::PRIVATE, NULL );
...
void	CBasicChatRightBody::BEGIN_PARTY_CHAT ( const CString& strMessage )
{
	...
	AddStringToNORMAL ( strCombine2, NS_UITEXTCOLOR::AQUAMARINE, NULL );
...
void	CBasicChatRightBody::BEGIN_TOALL_CHAT ( const CString& strMessage )
{
	...
	AddStringToNORMAL ( strCombine2, NS_UITEXTCOLOR::ORANGE, NULL );
...
void	CBasicChatRightBody::BEGIN_GUILD_CHAT ( const CString& strMessage )
{
	...
	AddStringToNORMAL ( strCombine2, NS_UITEXTCOLOR::VIOLET, NULL );
...
void	CBasicChatRightBody::BEGIN_ALLIANCE_CHAT( const CString& strMessage )
{
	...
	AddStringToNORMAL ( strCombine2, NS_UITEXTCOLOR::HOTPINK, NULL );
