...
CCharacterWindow::CCharacterWindow () :
	...
	m_pRBText ( NULL ), //add rb
	m_pPKWText ( NULL ), //add pk
	m_pPKLText ( NULL ), //add pk
	m_pPKRText ( NULL ), //add pkrank
	m_pHitRateText ( NULL ),
...
void CCharacterWindow::CreateSubControl ()
{
	...
	{
		CreateControl ( "CHARACTER_STATS_BACK_L" );
		CreateControl ( "CHARACTER_STATS_BACK_R" );
		pTextBox = CreateStaticControl ( "CHARACTER_STATS_STATIC_TITLE", pFont, nAlignCenter );
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_STATUS_STATIC", 14), dwSubTitle );
	...
	{	//	Status
		...
		pTextBox = CreateStaticControl ( "CHARACTER_CP_STATIC", pFont, nAlignLeft ); //add cp
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_STATUS_STATIC", 13), dwSilver );

		pTextBox = CreateStaticControl ( "CHARACTER_PKR_STATIC", pFont, nAlignLeft ); //add pkrank
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_STATUS_STATIC", 15), dwSilver );

		pTextBox = CreateStaticControl ( "CHARACTER_RB_STATIC", pFont, nAlignLeft ); //add rb
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_STATUS_STATIC", 16), dwSilver );

		pTextBox = CreateStaticControl ( "CHARACTER_PKW_STATIC", pFont, nAlignLeft ); //add pk
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_STATUS_STATIC", 17), dwSilver );

		pTextBox = CreateStaticControl ( "CHARACTER_PKL_STATIC", pFont, nAlignLeft ); //add pk
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_STATUS_STATIC", 18), dwSilver );
		...
		m_pCPText = CreateStaticControl ( "CHARACTER_CP_TEXT", pFont8Shadow, nAlignLeft ); //add cp
		m_pPKRText = CreateStaticControl ( "CHARACTER_PKR_TEXT", pFont8Shadow, nAlignLeft ); //add pkrank

		m_pRBText = CreateStaticControl ( "CHARACTER_RB_TEXT", pFont8Shadow, nAlignLeft ); //add rb
		m_pPKWText = CreateStaticControl ( "CHARACTER_PKW_TEXT", pFont8Shadow, nAlignLeft ); //add pk
		m_pPKLText = CreateStaticControl ( "CHARACTER_PKL_TEXT", pFont8Shadow, nAlignLeft ); //add pk
	...
	{
		CUIControl	TempControl;
		TempControl.Create ( 1, "CHARACTER_RANK_MARK" );
		...
		{
			m_pRankMark[i] = CreateControl ( strRankMark[i].GetString() );
