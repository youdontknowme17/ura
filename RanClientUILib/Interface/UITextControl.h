...
#include "../EngineUIlib/GUInterface/UITextUtil.h"
...
namespace	NS_UITEXTCOLOR
{
	...
	const DWORD JERMTHESLAYER	= D3DCOLOR_ARGB(0xFF,0,132,255);
	const DWORD	BLUE			= D3DCOLOR_ARGB(0xFF,0x00,0x00,0xFF);
	const DWORD	LIME			= D3DCOLOR_ARGB(0xFF,0x00,0xFF,0x00);
	...
	const DWORD GREEN           = D3DCOLOR_ARGB(255, 000, 255, 000);
	const DWORD TEST  = D3DCOLOR_ARGB(0xFF,0x00,0x80,0x4D);
// clubBattle »ç¿ëÇÒ·Á°í Ãß°¡ ( »ö»ó°ª Á¶±Ý¾¿ Æ²¸² ) 
	...
	const DWORD RARE			= D3DCOLOR_ARGB(0xFF,0xFF,0xD7,0x00);
	const DWORD HEROIC			= D3DCOLOR_ARGB(0xFF,0xFF,0x00,0xDC);
	const DWORD ANCIENT			= D3DCOLOR_ARGB(0xFF,0xFF,0xA5,0x00);
	const DWORD LEGENDARY		= D3DCOLOR_ARGB(0xFF,0xFF,0x69,0xB4);
	const DWORD HIGHCLASS		= D3DCOLOR_ARGB(0xFF,0x7F,0xFF,0xD4);
	const DWORD VOTEITEM		= D3DCOLOR_ARGB(255,051,255,051);
	const DWORD	PREMIUMITEM		= D3DCOLOR_ARGB(255,255,051,051);
	const DWORD LITEBLUE		= D3DCOLOR_ARGB(255,118,238,198);
