	...
	, DelChar(FALSE)
{
	...
	memset ( m_pCharacterClassPos1, 0, sizeof( CUIControl* ) * GLCI_NUM_2015 );
	memset ( m_pCharacterClassSetPos1, 0, sizeof( CUIControl* ) * GLCI_NUM_2015 );
	memset ( m_pCharacterClassPos2, 0, sizeof( CUIControl* ) * GLCI_NUM_2015 );
	memset ( m_pCharacterClassSetPos2, 0, sizeof( CUIControl* ) * GLCI_NUM_2015 );
	memset ( m_pCharacterClassPos3, 0, sizeof( CUIControl* ) * GLCI_NUM_2015 );
	memset ( m_pCharacterClassSetPos3, 0, sizeof( CUIControl* ) * GLCI_NUM_2015 );
	memset ( m_pCharacterClassPos4, 0, sizeof( CUIControl* ) * GLCI_NUM_2015 );
	memset ( m_pCharacterClassSetPos4, 0, sizeof( CUIControl* ) * GLCI_NUM_2015 );
...
void CSelectCharacterPage::CreateSubControl ()
{
	...
	pSelectCharacterPage->CreateSub ( this, "CUASO_NGOAI", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
			...
			if ( CHECK_KEYFOCUSED ( dwMsg ) || CHECK_MOUSEIN_LBUPLIKE ( dwMsg ) )
			{
				...
				if (m_nPosition > -1)
				{
					...
					if (m_nPosition == 0)
					{
						...
						else if( pCharInfoA->m_emClass == GLCC_SHAPER_M )
						{
							m_pCharacterClassPos1[16]->SetVisibleSingle ( TRUE );
							m_pCharacterClassSetPos1[16]->SetVisibleSingle ( FALSE );
						}
						else if( pCharInfoA->m_emClass == GLCC_SHAPER_W )
						{
							m_pCharacterClassPos1[17]->SetVisibleSingle ( TRUE );
							m_pCharacterClassSetPos1[17]->SetVisibleSingle ( FALSE );
						}
					}
					else if (m_nPosition == 1)
					{
						...
						else if( pCharInfoB->m_emClass == GLCC_SHAPER_M )
						{
							m_pCharacterClassPos2[16]->SetVisibleSingle ( TRUE );
							m_pCharacterClassSetPos2[16]->SetVisibleSingle ( FALSE );
						}
						else if( pCharInfoB->m_emClass == GLCC_SHAPER_W )
						{
							m_pCharacterClassPos2[17]->SetVisibleSingle ( TRUE );
							m_pCharacterClassSetPos2[17]->SetVisibleSingle ( FALSE );
						}
					}
					else if (m_nPosition == 2)
					{
						...
						else if( pCharInfoC->m_emClass == GLCC_SHAPER_M )
						{
							m_pCharacterClassPos3[16]->SetVisibleSingle ( TRUE );
							m_pCharacterClassSetPos3[16]->SetVisibleSingle ( FALSE );
						}
						else if( pCharInfoC->m_emClass == GLCC_SHAPER_W )
						{
							m_pCharacterClassPos3[17]->SetVisibleSingle ( TRUE );
							m_pCharacterClassSetPos3[17]->SetVisibleSingle ( FALSE );
						}
					}
					else if (m_nPosition == 3)
					{
						...
						else if( pCharInfoD->m_emClass == GLCC_SHAPER_M )
						{
							m_pCharacterClassPos4[16]->SetVisibleSingle ( TRUE );
							m_pCharacterClassSetPos4[16]->SetVisibleSingle ( FALSE );
						}
						else if( pCharInfoD->m_emClass == GLCC_SHAPER_W )
						{
							m_pCharacterClassPos4[17]->SetVisibleSingle ( TRUE );
							m_pCharacterClassSetPos4[17]->SetVisibleSingle ( FALSE );
						}
					}
...
void CSelectCharacterPage::SELECT_CLASS_PROCESS( int nSelect )
{
	...
	if (m_nPosition == 0)
	{
		...
		{
			m_pCharacterClassPos1[16]->SetVisibleSingle ( FALSE );
			m_pCharacterClassSetPos1[16]->SetVisibleSingle ( TRUE );
		}
		else if( pCharInfoA->m_emClass == GLCC_SHAPER_W )
		{
			m_pCharacterClassPos1[17]->SetVisibleSingle ( FALSE );
			m_pCharacterClassSetPos1[17]->SetVisibleSingle ( TRUE );
		}
	}
	else if (m_nPosition == 1)
	{
		...
		{
			m_pCharacterClassPos2[16]->SetVisibleSingle ( FALSE );
			m_pCharacterClassSetPos2[16]->SetVisibleSingle ( TRUE );
		}
		else if( pCharInfoB->m_emClass == GLCC_SHAPER_W )
		{
			m_pCharacterClassPos2[17]->SetVisibleSingle ( FALSE );
			m_pCharacterClassSetPos2[17]->SetVisibleSingle ( TRUE );
		}
	}
	else if (m_nPosition == 2)
	{
		...
		{
			m_pCharacterClassPos3[16]->SetVisibleSingle ( FALSE );
			m_pCharacterClassSetPos3[16]->SetVisibleSingle ( TRUE );
		}
		else if( pCharInfoC->m_emClass == GLCC_SHAPER_W )
		{
			m_pCharacterClassPos3[17]->SetVisibleSingle ( FALSE );
			m_pCharacterClassSetPos3[17]->SetVisibleSingle ( TRUE );
		}
	}
	else if (m_nPosition == 3)
	{
		...
		{
			m_pCharacterClassPos4[16]->SetVisibleSingle ( FALSE );
			m_pCharacterClassSetPos4[16]->SetVisibleSingle ( TRUE );
		}
		else if( pCharInfoD->m_emClass == GLCC_SHAPER_W )
		{
			m_pCharacterClassPos4[17]->SetVisibleSingle ( FALSE );
			m_pCharacterClassSetPos4[17]->SetVisibleSingle ( TRUE );
		}
	}
