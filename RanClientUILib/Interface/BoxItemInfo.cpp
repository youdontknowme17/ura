...
void CBoxItemInfo::CreateSubControl ()
{
	...
	m_pFont10 = DxFontMan::GetInstance().LoadDxFont ( _DEFAULT_FONT, 9, _DEFAULT_FONT_FLAG );
...
//Item Image Render by CNDev :: 07 / 08 / 2014
