...
private:	//	Status
	...
	void	SetCP ( const GLCHARLOGIC& sCharData ); //add cp
	void	SetRB ( const GLCHARLOGIC& sCharData ); //add rb
	void	SetPKW ( const GLCHARLOGIC& sCharData ); //add pk
	void	SetPKL ( const GLCHARLOGIC& sCharData ); //add pk
...
//	void	SetPK ( const GLCHARLOGIC& sCharData );
	...
	void	SetPkRank ( const GLCHARLOGIC& sCharData );		//	add pk
...
private:	//	Status
	...
	CBasicTextBox*	m_pRBText; //add rb
	CBasicTextBox*	m_pPKWText; //add pk
	CBasicTextBox*	m_pPKLText; //add pk
	CBasicTextBox*	m_pHitRateText;
	CBasicTextBox*	m_pAvoidRateText;
	CBasicTextBox*	m_pPremiumText;
	CBasicTextBox*	m_pPKRText; //add pkrank
...
private:
	...
	static const int nRANK_MARK = 20;
	CUIControl*	m_pRankMark[nRANK_MARK]; //add pkrank
