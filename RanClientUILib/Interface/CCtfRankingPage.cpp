...
void CCtfRankingPage::Init()
{
	...
	m_pCTFBaseContrib->AddText( ID2GAMEWORD( "CTF_RESULT_TEXT_BASE", 9 ), NS_UITEXTCOLOR::WHITE);	
}
...
void CCtfRankingPage::RefreshRankSlot( bool bMyRank, int wSchool )
{
	...
	{
        if ( !GLGaeaClient::GetInstance().m_bTowerWars ) m_pRankSlot[0]->SetVisibleSingle ( FALSE );
