	...
	case CHARACTER_POW_BUTTON:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				...
				CInnerInterface::GetInstance().SHOW_COMMON_LINEINFO (  ID2GAMEWORD ( "INC_STAT_DESC", 0 ), NS_UITEXTCOLOR::DEFAULT );
				...
				{	
					DWORD dwPow = GLGaeaClient::GetInstance().GetCharacter()->m_sStats.dwPow;
					if ( dwPow >= GLCONST_CHAR::dwPowMax )
					{
						CInnerInterface::GetInstance().PrintConsoleText ( ID2GAMEWORD ( "INC_STAT_ERROR", 0 ) );
					}
					else
					{
	...
	case CHARACTER_DEX_BUTTON:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				...
				CInnerInterface::GetInstance().SHOW_COMMON_LINEINFO (  ID2GAMEWORD ( "INC_STAT_DESC", 1 ), NS_UITEXTCOLOR::DEFAULT );
				...
				if ( CHECK_LB_UP_LIKE ( dwMsg ) )
				{
					DWORD dwDex = GLGaeaClient::GetInstance().GetCharacter()->m_sStats.dwDex;
					if ( dwDex >= GLCONST_CHAR::dwDexMax )
					{
						CInnerInterface::GetInstance().PrintConsoleText ( ID2GAMEWORD ( "INC_STAT_ERROR", 1 ) );
					}
					else
					{
	...
	case CHARACTER_SPI_BUTTON:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				...
				CInnerInterface::GetInstance().SHOW_COMMON_LINEINFO (  ID2GAMEWORD ( "INC_STAT_DESC", 2 ), NS_UITEXTCOLOR::DEFAULT );
				...
				if ( CHECK_LB_UP_LIKE ( dwMsg ) )
				{
					DWORD dwSpi = GLGaeaClient::GetInstance().GetCharacter()->m_sStats.dwSpi;
					if ( dwSpi >= GLCONST_CHAR::dwSpiMax )
					{
						CInnerInterface::GetInstance().PrintConsoleText ( ID2GAMEWORD ( "INC_STAT_ERROR", 2 ) );
					}
					else
					{
	...
	case CHARACTER_STR_BUTTON:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				...
				CInnerInterface::GetInstance().SHOW_COMMON_LINEINFO (  ID2GAMEWORD ( "INC_STAT_DESC", 3 ), NS_UITEXTCOLOR::DEFAULT );
				...
				if ( CHECK_LB_UP_LIKE ( dwMsg ) )
				{
					DWORD dwStr = GLGaeaClient::GetInstance().GetCharacter()->m_sStats.dwStr;
					if ( dwStr >= GLCONST_CHAR::dwStrMax )
					{
						CInnerInterface::GetInstance().PrintConsoleText ( ID2GAMEWORD ( "INC_STAT_ERROR", 3 ) );
					}
					else
					{
	...
	case CHARACTER_STA_BUTTON:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				...
				CInnerInterface::GetInstance().SHOW_COMMON_LINEINFO (  ID2GAMEWORD ( "INC_STAT_DESC", 4 ), NS_UITEXTCOLOR::DEFAULT );
				...
				if ( CHECK_LB_UP_LIKE ( dwMsg ) )
				{
					DWORD dwSta = GLGaeaClient::GetInstance().GetCharacter()->m_sStats.dwSta;
					if ( dwSta >= GLCONST_CHAR::dwStaMax )
					{
						CInnerInterface::GetInstance().PrintConsoleText ( ID2GAMEWORD ( "INC_STAT_ERROR", 4 ) );
					}
					else
					{
