...
class CCharacterWindowPetQuickSkillSlot : public CUIGroup
{
protected:
	enum
	{
...
public:
	CCharacterWindowPetQuickSkillSlot ();
	virtual	~CCharacterWindowPetQuickSkillSlot ();
...
public:
	//int nSkillSlot;
	//void	SetSkillSlot( int nSlot )	{	nSkillSlot = nSlot;	}
};