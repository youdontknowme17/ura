...
{	
	...
	{
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_HEAD",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_NECK",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_UPPER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_FIRST_LEFT_WEAPON",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_WRIST",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_HAND",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_LOWER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_LEFT_FINGER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_FIRST_RIGHT_WEAPON",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_FOOT",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_RIGHT_FINGER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_SECOND_RIGHT_WEAPON",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_SECOND_LEFT_WEAPON",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_VEHICLE",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_WAIST",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_LEFT_ACCESSORY",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_RIGHT_ACCESSORY",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_LEFT_EARRING",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_RIGHT_EARRING",
		//"CHARACTER_WINDOW_NEW_WEAR_SLOT_CON",
	};

	CString strInvenWearOver[ITEM_IMAGE_SIZE] = 
	{
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_HEAD_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_NECK_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_UPPER_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_FIRST_LEFT_WEAPON_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_WRIST_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_HAND_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_LOWER_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_LEFT_FINGER_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_FIRST_RIGHT_WEAPON_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_FOOT_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_RIGHT_FINGER_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_SECOND_RIGHT_WEAPON_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_SECOND_LEFT_WEAPON_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_VEHICLE_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_WAIST_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_LEFT_ACCESSORY_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_RIGHT_ACCESSORY_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_LEFT_EARRING_OVER",
		"CHARACTER_WINDOW_NEW_WEAR_SLOT_RIGHT_EARRING_OVER",
		//"CHARACTER_WINDOW_NEW_WEAR_SLOT_CON_OVER",
	};
	...
	m_pARHandSlot = CreateControl("CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_FIRST_RIGHT_WEAPON_USE");
	m_pALHandSlot = CreateControl("CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_FIRST_LEFT_WEAPON_USE");
	m_pBRHandSlot = CreateControl("CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_SECOND_RIGHT_WEAPON_USE");
	m_pBLHandSlot = CreateControl("CHARACTER_WINDOW_NEW_WEAR_SLOT_EX_SECOND_LEFT_WEAPON_USE");	
}
...
EMSLOT CCharacterWindowCharWearEx::IMAGE2EMSLOT ( int nIndex )
{
	...
	case ITEM_IMAGE14:	return SLOT_WAIST;
	case ITEM_IMAGE15:	return SLOT_RACCESSORY;
	case ITEM_IMAGE16:	return SLOT_LACCESSORY;
	case ITEM_IMAGE17:	return SLOT_LEARRING;
	case ITEM_IMAGE18:	return SLOT_REARRING;
