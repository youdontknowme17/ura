...
////////////////////////////////////////////////////////////////////
//	사용자 메시지 정의
const DWORD UIMSG_MOUSEIN_WEARSLOT_PET = UIMSG_USER1;
////////////////////////////////////////////////////////////////////
...
class	CPetWindow : public CUIWindowEx
{
	enum
	{
		...
		LOYALTY_TEXT,
		SKILL_COMBO_OPEN_A,
		SKILL_COMBO_ROLLOVER_A,
		SKILL_COMBO_OPEN_B,
		SKILL_COMBO_ROLLOVER_B,
		SKILL_BUTTON,
	...
	CBasicComboBox * m_pcbSkill_B;
	CBasicComboBoxRollOver * m_pcbSkillRollOver_B;
	int m_iSkillB;
