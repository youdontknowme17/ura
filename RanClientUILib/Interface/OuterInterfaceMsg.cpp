...
*/
				...
				{
					ToSelectCharacterPage ( NEW_LOGIN_PAGE );
				}
//#endif
			...
			case EM_LOGIN_FB_CH_FULL: // 최대 동접 인원 도달시 NET_MSG_SVR_FULL 메시지가 온다.
				...
				ToSelectServerPage ( NEW_LOGIN_PAGE );
				break;
	...
	{
		NET_REGISTERACCOUNT_FB_DATA* nrafbd = (NET_REGISTERACCOUNT_FB_DATA *)nmg;

		switch (nrafbd->nResult)
		{
		case EM_REGISTERACCOUNT_FB_SUB_FAIL: // Stage_9
		{
			DoModalOuter(ID2GAMEEXTEXT("REGISTER_PAGE_STAGE_9"), MODAL_INFOMATION, OK);
		...
		case EM_REGISTERACCOUNT_FB_SUB_INCORRECT: // Stage_10
		{
			DoModalOuter(ID2GAMEEXTEXT("REGISTER_PAGE_STAGE_10"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_REGISTERACCOUNT_FB_SUB_RANDOM_PASS: // // Stage_11
		{
			DoModalOuter(ID2GAMEEXTEXT("REGISTER_PAGE_STAGE_11"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_REGISTERACCOUNT_FB_SUB_OK: // Stage_12
		{
			DoModalOuter(ID2GAMEEXTEXT("REGISTER_PAGE_STAGE_12"), MODAL_INFOMATION, OK);
		...
		break;
		case EM_REGISTERACCOUNT_FB_SUB_INUSE_EMAIL: // Stage_12
		{
			DoModalOuter(ID2GAMEEXTEXT("REGISTER_PAGE_STAGE_14"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
	...
	{
		NET_FORGOTACCOUNT_FB_DATA* nfafbd = (NET_FORGOTACCOUNT_FB_DATA *)nmg;

		switch (nfafbd->nResult)
		{
		case EM_FORGOTACCOUNT_FB_SUB_FAIL: // Stage_2
		{
			DoModalOuter(ID2GAMEEXTEXT("FORGOTACCOUNT_PAGE_STAGE_2"), MODAL_INFOMATION, OK);
			...
			ToSelectServerPage(FORGOTACCOUNT_PAGE);
		}
		break;

		case EM_FORGOTACCOUNT_FB_SUB_INCORRECT: // Stage_3
		{
			DoModalOuter(ID2GAMEEXTEXT("FORGOTACCOUNT_PAGE_STAGE_3"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_FORGOTACCOUNT_FB_SUB_RANDOM_PASS: // Stage_4
		{
			DoModalOuter(ID2GAMEEXTEXT("FORGOTACCOUNT_PAGE_STAGE_4"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_FORGOTACCOUNT_FB_SUB_OK: // Stage_5
		{
			DoModalOuter(ID2GAMEEXTEXT("FORGOTACCOUNT_PAGE_STAGE_5"), MODAL_INFOMATION, OK);
	...
	{
		NET_CHANGEPASSWORD_FB_DATA* ncpfbd = (NET_CHANGEPASSWORD_FB_DATA *)nmg;

		switch (ncpfbd->nResult)
		{
		case EM_CHANGEPASSWORD_FB_SUB_FAIL: // Stage_4
		{
			DoModalOuter(ID2GAMEEXTEXT("CHANGEPASSWORD_PAGE_STAGE_4"), MODAL_INFOMATION, OK);
			...
			ToSelectServerPage(CHANGEPASSWORD_PAGE);
		}
		break;
		case EM_CHANGEPASSWORD_FB_SUB_INCORRECT: // Stage_5
		{
			DoModalOuter(ID2GAMEEXTEXT("CHANGEPASSWORD_PAGE_STAGE_5"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_CHANGEPASSWORD_FB_SUB_RANDOM_PASS: // Stage_6
		{
			DoModalOuter(ID2GAMEEXTEXT("CHANGEPASSWORD_PAGE_STAGE_6"), MODAL_INFOMATION, OK);
		...
		case EM_CHANGEPASSWORD_FB_SUB_OK: // Stage_7
		{
			DoModalOuter(ID2GAMEEXTEXT("CHANGEPASSWORD_PAGE_STAGE_7"), MODAL_INFOMATION, OK);
	...
	{
		NET_CHANGEPINCODE_FB_DATA* ncpfbd = (NET_CHANGEPINCODE_FB_DATA *)nmg;

		switch (ncpfbd->nResult)
		{
		case EM_CHANGEPINCODE_FB_SUB_FAIL: // Stage_4
		{
			DoModalOuter(ID2GAMEEXTEXT("CHANGEPINCODE_PAGE_STAGE_4"), MODAL_INFOMATION, OK);
			...
			ToSelectServerPage(CHANGEPINCODE_PAGE);
		}
		break;

		case EM_CHANGEPINCODE_FB_SUB_INCORRECT: // Stage_5
		{
			DoModalOuter(ID2GAMEEXTEXT("CHANGEPINCODE_PAGE_STAGE_5"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_CHANGEPINCODE_FB_SUB_RANDOM_PIN: // Stage_6
		{
			DoModalOuter(ID2GAMEEXTEXT("CHANGEPINCODE_PAGE_STAGE_6"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_CHANGEPINCODE_FB_SUB_OK: // Stage_7
		{
			DoModalOuter(ID2GAMEEXTEXT("CHANGEPINCODE_PAGE_STAGE_7"), MODAL_INFOMATION, OK);
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
	...
	{
		NET_FIXUSER_FB_DATA* nfufbd = (NET_FIXUSER_FB_DATA *)nmg;

		switch (nfufbd->nResult)
		{
		case EM_FIXUSER_FB_SUB_FAIL: // Stage_2
		{
			DoModalOuter(ID2GAMEEXTEXT("FIXUSER_PAGE_STAGE_2"), MODAL_INFOMATION, OK);
			...
			ToSelectServerPage(FIXUSER_PAGE);
		}
		break;

		case EM_FIXUSER_FB_SUB_INCORRECT: // Stage_3
		{
			DoModalOuter(ID2GAMEEXTEXT("FIXUSER_PAGE_STAGE_3"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_FIXUSER_FB_SUB_RANDOM_PASS: // Stage_4
		{
			DoModalOuter(ID2GAMEEXTEXT("FIXUSER_PAGE_STAGE_4"), MODAL_INFOMATION, OK);
			return;
			CNetClient* pNetClient = DxGlobalStage::GetInstance().GetNetClient();
		...
		case EM_FIXUSER_FB_SUB_OK: // Stage_5
		{
			DoModalOuter(ID2GAMEEXTEXT("FIXUSER_PAGE_STAGE_5"), MODAL_INFOMATION, OK);
