...
CPointShopWindowMenuButton::CPointShopWindowMenuButton ()
	: m_pIcon00( NULL )
	, m_pIcon01( NULL )
{
}
...
void CPointShopWindowMenuButton::CreateSubControl( CString strKeywordOff, CString strKeywordOn )
{
...
void CPointShopWindowMenuButton::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
	switch( ControlID )
	{
	case ICON_OFF:
