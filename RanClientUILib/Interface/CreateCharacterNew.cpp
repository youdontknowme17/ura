...
void CCreateCharacterNew::CreateSubControl()
{
	...
	//พื้นหลังในส่วนของหัวข้?เลือกโรงเรีย?
	{
	...
	//พื้นหลังในส่วนของหัวข้?เลือกเพศ
	{
	...
	//พื้นหลังในส่วนของหัวข้?เลือกอาชีพ
	{
	...
	//พื้นหลังในส่วนของหัวข้?เลือกสไตล์
	{
	...
	//ปุ่มกดเลือกโรงเรีย?SG ยังไม่ได้ก?
	{		
	...
	//ปุ่มกดเลือกโรงเรีย?SG ตอนที่กด
	{
	...
	//ปุ่มกดเลือกโรงเรีย?MP ยังไม่ได้ก?
	{	
	...
	//ปุ่มกดเลือกโรงเรีย?MP ตอนที่กด
	{
	...
	//ปุ่มกดเลือกโรงเรีย?PH ยังไม่ได้ก?
	{
	...
	//ปุ่มกดเลือกโรงเรีย?PH ตอนที่กด
	{
...
void CCreateCharacterNew::PREV_STEP()
{
	...
	// ตำแหน่งเดิมของ ข้อมูล ??
	Pos3 = m_pSchoolDec->GetGlobalPos();
	// กำหนัดค่าใหม่โดยใหม่เท่ากับตำแหน่งเดิม
	Pos5 = Pos2; // ชื่อ
	Pos6 = Pos3; // ข้อมูล
...
void CCreateCharacterNew::SELECT_SEX_PROCESS( int nSelect )
{
	...
	// พื้นหลัง ?? เปลี่ยนตำแหน่ง
	/*UIRECT Pos,newPos,newPos2;
	//ตำแหน่งเดิมของ พื้นหลัง ??
	Pos = pBasicLineBoxSchool->GetGlobalPos();
	//ตำแหน่งเดิมของ พื้นหลัง เพ?
	newPos = pBasicLineBoxSex->GetGlobalPos();

	// ตำแห่น??? ใหม่ แกนเอ็กซ?- ด้วยความกว้า?ขอ?พื้นหลัง เพ?
	newPos2.left = newPos.left - newPos.sizeX;
	// ตำแหน่?วา?ใหม่ เท่ากลับ ตำแหน่งวาย ของพื้นหลั?เพ?
	newPos2.top = newPos.top;
	// ตั้งต่?เดิม ขอ?กว้า?แล?ยา?
	newPos2.sizeX = Pos.sizeX;
	newPos2.sizeY = Pos.sizeY;
	
	// เซ?ตำแหน่งใหม?ให?พื้นหลัง ??
