...
void CBasicLineBoxEx::CreateBaseBoxVarTextBoxGreen ( char* szBoxControl )
{
	CreateBodyImage ( "BASIC_LINE_BOX_EX_BODY_VARTEXT_GREEN" );
	CreateLineImage ( "BASIC_LINE_BOX_EX_LEFT_VARTEXT_GREEN", "BASIC_LINE_BOX_EX_RIGHT_VARTEXT_GREEN", "BASIC_LINE_BOX_EX_TOP_VARTEXT_GREEN", "BASIC_LINE_BOX_EX_BOTTOM_VARTEXT_GREEN" );
	CreateLineImageEx ( "BASIC_LINE_BOX_EX_LEFTTOP_VARTEXT_GREEN", "BASIC_LINE_BOX_EX_LEFTBOTTOM_VARTEXT_GREEN", "BASIC_LINE_BOX_EX_RIGHTTOP_VARTEXT_GREEN", "BASIC_LINE_BOX_EX_RIGHTBOTTOM_VARTEXT_GREEN" );
	ResizeControl ( szBoxControl );	
}
void CBasicLineBoxEx::CreateBaseBoxVarTextBoxGrayish ( char* szBoxControl )
{
	CreateBodyImage ( "BASIC_LINE_BOX_EX_BODY_VARTEXT_GRAY" );
	CreateLineImage ( "BASIC_LINE_BOX_EX_LEFT_VARTEXT_GRAY", "BASIC_LINE_BOX_EX_RIGHT_VARTEXT_GRAY", "BASIC_LINE_BOX_EX_TOP_VARTEXT_GRAY", "BASIC_LINE_BOX_EX_BOTTOM_VARTEXT_GRAY" );
	CreateLineImageEx ( "BASIC_LINE_BOX_EX_LEFTTOP_VARTEXT_GRAY", "BASIC_LINE_BOX_EX_LEFTBOTTOM_VARTEXT_GRAY", "BASIC_LINE_BOX_EX_RIGHTTOP_VARTEXT_GRAY", "BASIC_LINE_BOX_EX_RIGHTBOTTOM_VARTEXT_GRAY" );
	ResizeControl ( szBoxControl );	
}
void CBasicLineBoxEx::CreateBaseBoxLoiBox ( char* szBoxControl )
{
	CreateBodyImage ( "BASIC_LINE_BOX_EX_BODY_LOI" );
	CreateLineImage ( "BASIC_LINE_BOX_EX_LEFT_LOI", "BASIC_LINE_BOX_EX_RIGHT_LOI", "BASIC_LINE_BOX_EX_TOP_LOI", "BASIC_LINE_BOX_EX_BOTTOM_LOI" );
	CreateLineImageEx ( "BASIC_LINE_BOX_EX_LEFTTOP_LOI", "BASIC_LINE_BOX_EX_LEFTBOTTOM_LOI", "BASIC_LINE_BOX_EX_RIGHTTOP_LOI", "BASIC_LINE_BOX_EX_RIGHTBOTTOM_LOI" );
	ResizeControl ( szBoxControl );	
}
...
{
	CreateBodyImage ( "BASIC_LINE_BOX_EX_BODY_DIALOGUE_GRAY_BACK" );
	CreateLineImage ( "BASIC_LINE_BOX_EX_LEFT_DIALOGUE_GRAY_BACK", "BASIC_LINE_BOX_EX_RIGHT_DIALOGUE_GRAY_BACK", "BASIC_LINE_BOX_EX_TOP_DIALOGUE_GRAY_BACK", "BASIC_LINE_BOX_EX_BOTTOM_DIALOGUE_GRAY_BACK" );
	CreateLineImageEx ( "BASIC_LINE_BOX_EX_LEFTTOP_DIALOGUE_GRAY_BACK", "BASIC_LINE_BOX_EX_LEFTBOTTOM_DIALOGUE_GRAY_BACK", "BASIC_LINE_BOX_EX_RIGHTTOP_DIALOGUE_GRAY_BACK", "BASIC_LINE_BOX_EX_RIGHTBOTTOM_DIALOGUE_GRAY_BACK" );
	ResizeControl ( szBoxControl );	
}
...
void CBasicLineBoxEx::BlackCatYBDenXamBox ( char* szBoxControl )
{
	CreateBodyImage ( "BLACKCATYB_DEN_XAM_GIUA" );
	CreateLineImage ( "BLACKCATYB_DEN_XAM_TRAI", "BLACKCATYB_DEN_XAM_PHAI", "BLACKCATYB_DEN_XAM_TREN", "BLACKCATYB_DEN_XAM_DUOI" );
	CreateLineImageEx ( "BLACKCATYB_DEN_XAM_TRAITREN", "BLACKCATYB_DEN_XAM_TRAIDUOI", "BLACKCATYB_DEN_XAM_PHAITREN", "BLACKCATYB_DEN_XAM_PHAIDUOI" );
	ResizeControl ( szBoxControl );
}
void CBasicLineBoxEx::BlackCatYBXamDenBox ( char* szBoxControl )
{
	CreateBodyImage ( "BLACKCATYB_XAM_DEN_GIUA" );
	CreateLineImage ( "BLACKCATYB_XAM_DEN_TRAI", "BLACKCATYB_XAM_DEN_PHAI", "BLACKCATYB_XAM_DEN_TREN", "BLACKCATYB_XAM_DEN_DUOI" );
	CreateLineImageEx ( "BLACKCATYB_XAM_DEN_TRAITREN", "BLACKCATYB_XAM_DEN_TRAIDUOI", "BLACKCATYB_XAM_DEN_PHAITREN", "BLACKCATYB_XAM_DEN_PHAIDUOI" );
	ResizeControl ( szBoxControl );
}
void CBasicLineBoxEx::BlackCatYBDenTrangBox ( char* szBoxControl )
{
	CreateBodyImage ( "BLACKCATYB_DEN_TRANG_GIUA" );
	CreateLineImage ( "BLACKCATYB_DEN_TRANG_TRAI", "BLACKCATYB_DEN_TRANG_PHAI", "BLACKCATYB_DEN_TRANG_TREN", "BLACKCATYB_DEN_TRANG_DUOI" );
	CreateLineImageEx ( "BLACKCATYB_DEN_TRANG_TRAITREN", "BLACKCATYB_DEN_TRANG_TRAIDUOI", "BLACKCATYB_DEN_TRANG_PHAITREN", "BLACKCATYB_DEN_TRANG_PHAIDUOI" );
	ResizeControl ( szBoxControl );
}
void CBasicLineBoxEx::BlackCatYBDTDXBox ( char* szBoxControl )
{
	CreateBodyImage ( "BLACKCATYB_DTDX_GIUA" );
	CreateLineImage ( "BLACKCATYB_DTDX_TRAI", "BLACKCATYB_DTDX_PHAI", "BLACKCATYB_DTDX_TREN", "BLACKCATYB_DTDX_DUOI" );
	CreateLineImageEx ( "BLACKCATYB_DTDX_TRAITREN", "BLACKCATYB_DTDX_TRAIDUOI", "BLACKCATYB_DTDX_PHAITREN", "BLACKCATYB_DTDX_PHAIDUOI" );
	ResizeControl ( szBoxControl );
}
void CBasicLineBoxEx::BlackCatYBDTDDBox ( char* szBoxControl )
{
	CreateBodyImage ( "BLACKCATYB_DTDD_GIUA" );
	CreateLineImage ( "BLACKCATYB_DTDD_TRAI", "BLACKCATYB_DTDD_PHAI", "BLACKCATYB_DTDD_TREN", "BLACKCATYB_DTDD_DUOI" );
	CreateLineImageEx ( "BLACKCATYB_DTDD_TRAITREN", "BLACKCATYB_DTDD_TRAIDUOI", "BLACKCATYB_DTDD_PHAITREN", "BLACKCATYB_DTDD_PHAIDUOI" );
	ResizeControl ( szBoxControl );
}
void CBasicLineBoxEx::BlackCatYBDXXXBox ( char* szBoxControl )
{
	CreateBodyImage ( "BLACKCATYB_DXXX_GIUA" );
	CreateLineImage ( "BLACKCATYB_DXXX_TRAI", "BLACKCATYB_DXXX_PHAI", "BLACKCATYB_DXXX_TREN", "BLACKCATYB_DXXX_DUOI" );
	CreateLineImageEx ( "BLACKCATYB_DXXX_TRAITREN", "BLACKCATYB_DXXX_TRAIDUOI", "BLACKCATYB_DXXX_PHAITREN", "BLACKCATYB_DXXX_PHAIDUOI" );
	ResizeControl ( szBoxControl );
}
void CBasicLineBoxEx::BlackCatYBDVDXBox ( char* szBoxControl )
{
	CreateBodyImage ( "BLACKCATYB_DVDX_GIUA" );
	CreateLineImage ( "BLACKCATYB_DVDX_TRAI", "BLACKCATYB_DVDX_PHAI", "BLACKCATYB_DVDX_TREN", "BLACKCATYB_DVDX_DUOI" );
	CreateLineImageEx ( "BLACKCATYB_DVDX_TRAITREN", "BLACKCATYB_DVDX_TRAIDUOI", "BLACKCATYB_DVDX_PHAITREN", "BLACKCATYB_DVDX_PHAIDUOI" );
	ResizeControl ( szBoxControl );
}
void CBasicLineBoxEx::BlackCatYBDXDXBox ( char* szBoxControl )
{
	CreateBodyImage ( "BLACKCATYB_DXDX_GIUA" );
	CreateLineImage ( "BLACKCATYB_DXDX_TRAI", "BLACKCATYB_DXDX_PHAI", "BLACKCATYB_DXDX_TREN", "BLACKCATYB_DXDX_DUOI" );
	CreateLineImageEx ( "BLACKCATYB_DXDX_TRAITREN", "BLACKCATYB_DXDX_TRAIDUOI", "BLACKCATYB_DXDX_PHAITREN", "BLACKCATYB_DXDX_PHAIDUOI" );
	ResizeControl ( szBoxControl );
}
