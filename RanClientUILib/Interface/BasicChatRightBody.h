...
const DWORD UIMSG_MOUSEIN_LEFTBAR_DRAG	= UIMSG_USER2;
////////////////////////////////////////////////////////////////////
...
public:
	...
	void	AddItemLink( SITEMCUSTOM* pITEM );
	void	AddItemLinkGlobalGrind( SITEMCUSTOM* pITEM );
...
public:
	void	ADD_CHATLOG ( const CString& strChat, SITEMLINK sItemLink ); // 채팅메세지를 리스트에 추가
...
private:
	...
	void	ADD_CHAT_PAGE_TEXTBOX ( const CString& strTemp, const D3DCOLOR& dwColor, CBasicTextBoxEx* pTextBox, CBasicScrollBarEx* pScrollBar, SITEMLINK* pItemLink );
...
public:
	...
	void	CheckItemLink( CString strTEXT, SITEMLINK sLINK );
	void	CheckPreviewItemLink( CString strTEXT, SITEMLINK sLINK );
private:
