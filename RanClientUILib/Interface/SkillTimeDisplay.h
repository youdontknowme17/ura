...
public:
	...
	DWORD m_dwSLOT;
	SNATIVEID sSKILLID[SKILLFACT_SIZE];
	void SetSkillSlot( DWORD dwSlot ) { m_dwSLOT = dwSlot; }
	DWORD GetSkillSlot() { return m_dwSLOT; } 
	SNATIVEID GetSkillSlotID( DWORD dwSlot ) { return sSKILLID[dwSlot]; }
};