...
BOOL CQuestPage::OnInitDialog()
{
	...
	strTemp[0] = "No Event";
	strTemp[1] = "Char Death";
	strTemp[2] = "Move to Start";
	strTemp[3] = "Move to Specified Place";
	...
	SetWin_Combo_Init( this, IDC_MAP_SELECT_COMBO, strTemp, 1 );
...
void CQuestPage::UpdateItems ()
{
	...
	SetWin_Check ( this, IDC_CHECK_SCIENCE_M2, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_SCIENCE_M) ); 
	SetWin_Check ( this, IDC_CHECK_SCIENCE_W2, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_SCIENCE_W) );

	SetWin_Check ( this, IDC_CHECK_ASSASIN_M3, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_ASSASIN_M) ); 
	SetWin_Check ( this, IDC_CHECK_ASSASIN_W3, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_ASSASIN_W) );

	SetWin_Check ( this, IDC_CHECK_TESTING_M4, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_TESTING_M) ); 
	SetWin_Check ( this, IDC_CHECK_TESTING_W4, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_TESTING_W) );

	SetWin_Check ( this, IDC_CHECK_TESTING_M5, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_SHAPER_M) ); 
	SetWin_Check ( this, IDC_CHECK_TESTING_W5, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_SHAPER_W) );
	...
	SetWin_Num_int ( this, IDC_EDIT_SCHOOL, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.wSCHOOL );
...
void CQuestPage::InverseUpdateItems ()
{
	...
	GetWin_Check ( this, IDC_CHECK_SCIENCE_M2, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_SCIENCE_M ); 
	GetWin_Check ( this, IDC_CHECK_SCIENCE_W2, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_SCIENCE_W ); 

	GetWin_Check ( this, IDC_CHECK_ASSASIN_M3, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_ASSASIN_M ); 
	GetWin_Check ( this, IDC_CHECK_ASSASIN_W3, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_ASSASIN_W ); 

	GetWin_Check ( this, IDC_CHECK_TESTING_M4, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_TESTING_M ); 
	GetWin_Check ( this, IDC_CHECK_TESTING_W4, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_TESTING_W );

	GetWin_Check ( this, IDC_CHECK_TESTING_M5, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_SHAPER_M ); 
	GetWin_Check ( this, IDC_CHECK_TESTING_W5, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_SHAPER_W );
...
void CQuestPage::OnBnClickedButtonEditcomplate()
{
	...
	if( m_tempProgressEvent.bUseProgressEvent )
	{
		if( m_tempProgressEvent.dwEndProgress != EMQP_NON_EVENT )
		{
			...
			{
				MessageBox( "Please Select Proper Type for [COMPLETE] Progress" );
				return;
			}
		}
		...
		if( m_tempProgressEvent.dwStartProgress == EMQP_SELECT_MOVE )
		{
			...
			{
				MessageBox( "[START]Map MID , Map SID , Map Position EMPTY! Please ReCheck" );
				return;
			}
			...
			if( m_tempProgressEvent.startMap.wPosX != USHRT_MAX &&
				...
				m_tempProgressEvent.startMap.dwGateID != 0 )
			{
				MessageBox( "[START]Map Position and Gate ID modified ! /n Please modify only Map Position or Gate , /n Dont Modify Both /n When Map Position is Not (65535) you cannot use Gate ID other than 0" );
				return;
			}
		}
		if( m_tempProgressEvent.dwEndProgress == EMQP_SELECT_MOVE )
		{
			...
			{
				MessageBox( "[COMPLETE]]Map MID , Map SID , Map Position EMPTY! Please ReCheck" );
				return;
			}
			...
			if( m_tempProgressEvent.endMap.wPosX != USHRT_MAX &&
				...
				m_tempProgressEvent.endMap.dwGateID != 0 )
			{
				MessageBox( "[COMPLETE]Map Position and Gate ID modified ! /n Please modify only Map Position or Gate , /n Dont Modify Both /n When Map Position is Not (65535) you cannot use Gate ID other than 0" );
				return;
			}
		}
		if( m_tempProgressEvent.dwFailProgress == EMQP_SELECT_MOVE )
		{
			...
			{
				MessageBox( "[FAILURE]Map MID , Map SID , Map Position EMPTY! Please ReCheck" );
				return;
			}
			...
			if( m_tempProgressEvent.failMap.wPosX != USHRT_MAX &&
				...
				m_tempProgressEvent.failMap.dwGateID != 0 )
			{
				MessageBox( "[FAILURE]Map Position and Gate ID modified ! /n Please modify only Map Position or Gate , /n Dont Modify Both /n When Map Position is Not (65535) you cannot use Gate ID other than 0" );
				return;
			}
		}
	}
...
//  리소스 추가시 수정 요망  
	...
	SetWin_Enable( this, IDC_CHECK_ASSASIN_M3, FALSE );
	SetWin_Enable( this, IDC_CHECK_ASSASIN_W3, FALSE );
	SetWin_Enable( this, IDC_CHECK_TESTING_M4, FALSE );
	SetWin_Enable( this, IDC_CHECK_TESTING_W4, FALSE );
	SetWin_Enable( this, IDC_CHECK_TESTING_M5, FALSE );
	SetWin_Enable( this, IDC_CHECK_TESTING_W5, FALSE );
...
void CQuestPage::OnBnClickedRadioM()
{
	...
	SetWin_Check ( this, IDC_CHECK_SCIENCE_W2, false );
	SetWin_Check ( this, IDC_CHECK_ASSASIN_W3, false );
	SetWin_Check ( this, IDC_CHECK_TESTING_W4, false );
	SetWin_Check ( this, IDC_CHECK_TESTING_W5, false );
	...
	SetWin_Check ( this, IDC_CHECK_SCIENCE_M2, bCheck );
	SetWin_Check ( this, IDC_CHECK_ASSASIN_M3, bCheck );
	SetWin_Check ( this, IDC_CHECK_TESTING_M4, bCheck );
	SetWin_Check ( this, IDC_CHECK_TESTING_M5, bCheck );}

void CQuestPage::OnBnClickedRadioW()
{
	...
	SetWin_Check ( this, IDC_CHECK_SCIENCE_W2, bCheck );
	SetWin_Check ( this, IDC_CHECK_ASSASIN_W3, bCheck );
	SetWin_Check ( this, IDC_CHECK_TESTING_W4, bCheck );
	SetWin_Check ( this, IDC_CHECK_TESTING_W5, bCheck );
	...
	SetWin_Check ( this, IDC_CHECK_SCIENCE_M2, false );
	SetWin_Check ( this, IDC_CHECK_ASSASIN_M3, false );
	SetWin_Check ( this, IDC_CHECK_TESTING_M4, false );
	SetWin_Check ( this, IDC_CHECK_TESTING_M5, false );
}
