...
#if defined(KRT_PARAM) || defined(KR_PARAM) || defined(CH_PARAM) || defined(TH_PARAM) || defined(TW_PARAM) || defined(HK_PARAM) || defined( PH_PARAM )  || defined(ID_PARAM) || defined ( JP_PARAM ) || defined(GS_PARAM) || defined(_RELEASED)  // 필리핀 아이템샵
	...
	m_bVisibleGUI( FALSE )
{
	...
	m_dwCreationWidth   = 800; //default resolution
...
VOID CD3DApplication::Present()
{
	if( m_bVisibleGUI )
	{
		RECT rcTop = { 0, 0, m_d3dsdBackBuffer.Width, m_rtBoundGUI.top };
		RECT rcBottom = { 0, m_rtBoundGUI.bottom, m_d3dsdBackBuffer.Width, m_d3dsdBackBuffer.Height };
		RECT rcLeft	= { 0, m_rtBoundGUI.top, m_rtBoundGUI.left, m_rtBoundGUI.bottom };
		RECT rcRight = { m_rtBoundGUI.right, m_rtBoundGUI.top, m_d3dsdBackBuffer.Width, m_rtBoundGUI.bottom };
