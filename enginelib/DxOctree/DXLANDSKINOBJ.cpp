...
const DWORD	DXLANDSKINOBJ::VERSION_SAVE = 0x0102;
...
HRESULT DXLANDSKINOBJ::Load ( CSerialFile	&SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DXLANDSKINOBJ::Load Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
