...
const DWORD DxSetLandMan::VERSION_SAVE = 0x00000031;
...
void DxSetLandMan::LoadSet ( LPDIRECT3DDEVICEQ pd3dDevice, const char *pFileName )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffCharAmbient::LoadFile Error! Name:%s Version:%d Current Version:%d" ,SFile.GetFileName(),dwFileVer,DxSetLandMan::VERSION);
...
void DxSetLandMan::SaveSet ( LPDIRECT3DDEVICEQ pd3dDevice, const char *pFileName )
{
	...
	char szFileType[FILETYPESIZE] = "";
	SFile.SetFileType ( szFileType, DxSetLandMan::VERSION_SAVE );
