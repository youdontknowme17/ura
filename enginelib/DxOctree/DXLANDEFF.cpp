...
DWORD DXLANDEFF::VERSION_SAVE	= 0x0101;
...
HRESULT DXLANDEFF::Load ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DXLANDEFF::Load Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
