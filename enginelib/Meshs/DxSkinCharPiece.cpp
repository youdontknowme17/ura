...
HRESULT DxSkinCharPiece::Render ( const LPDIRECT3DDEVICEQ pd3dDevice, const D3DXMATRIX &matRot, const BOOL bShadow, const BOOL bEff, const BOOL bReverse )
{
	...
	D3DXMatrixMultiply( &matLocalRot, &matScale, &matRot );	//fix abl
	...
	//D3DXMatrixMultiply( &matLocalRot, &matScale, &matRot );	//old
	D3DXMatrixMultiply( &matLocalRot, &matScale, &matLocalRot );	//fix abl
