...
const DWORD	DxMaterialHLSL::VERSION_SAVE = 0x0100;
...
void DxMaterialHLSL::Load( LPDIRECT3DDEVICEQ pd3dDevice, basestream& SFile )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxMaterialHLSL::Load Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVER,dwBufferSize,VERSION);
