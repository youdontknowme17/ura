...
{
private:
	typedef stdext::hash_map<std::string,SAnimContainer*>			ANIMCONTMAP;
	typedef stdext::hash_map<std::string,SAnimContainer*>::iterator	ANIMCONTMAP_ITER;
...
namespace COMMENT
{
	extern std::string ANI_MAINTYPE[AN_TYPE_SIZE]; //main Ani Keys
	extern std::string ANI_MAINTYPE_00[ANI_VEHICLE_SIZE]; //Vehicle main Ani Keys
	extern std::string ANI_MAINTYPE_01[ANI_ABL_SIZE]; //Vehicle main Ani Keys
	extern std::string ANI_SUBTYPE[AN_SUB_SIZE]; //weapon animation
	extern std::string ANI_SUBTYPE_00[AN_SUB_00_SIZE]; //skill animation
	extern std::string ANI_SUBTYPE_01[AN_SUB_01_SIZE]; //vehicle sub animation
