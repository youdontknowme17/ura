...
const	DWORD	DxEffectSnow::VERSION_SAVE	=	0x102;
...
void	DxEffectSnow::LoadSet ( CSerialFile &SFile )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectSnow::LoadSet Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwBuffSize,VERSION);
...
const	DWORD	DxEffectLeaves::VERSION_SAVE	=	0x100;
