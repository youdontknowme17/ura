...
protected:
	...
	float			m_fDefaultVELOMOVE;//lev톝펃
...
public:
	...
	void SetMoveVelocity( float fVal )			{ m_fVELOMOVE = fVal;	}//lev톝펃
	void ResetMoveVelocity()	{	m_fVELOMOVE = m_fDefaultVELOMOVE;	}
	float GetMoveVelocity()		{	return m_fVELOMOVE;	}
	BOOL IsDefaultVelocity()	{	return	m_fVELOMOVE == m_fDefaultVELOMOVE;	}
public:
...
public:
	...
	void GetRctPos( RECT& rect );//add chat view item
