...
protected:
	...
	static const DWORD	VERSION_SAVE;
...
public:
	...
	void Load ( const LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile, const BOOL bDynamicLoad, BOOL bPiece );
	void Load_VER100 ( const LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile );
	void Load_EP9 ( const LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile, const BOOL bDynamicLoad, BOOL bPiece );
	void SetName( std::string strNAME )	{	m_szTexName = strNAME.c_str();	}
