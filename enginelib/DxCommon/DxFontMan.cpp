...
char _DEFAULT_FONT[128] = _T("Tahoma");
char _BOLD_FONT[128] = _T("Arial Bold");
...
{
	//use small fonts
	//part of add fontshadow
	if (RANPARAM::bSmallFont ) //use small fonts when set in ranparam
	{
		if  (dwHeight >= 9 ) dwHeight -=1;
	}
