...
//add sw buff
#include "../../RanClientLib/G-Logic/GLTowerWars/GLTowerWars.h" // struct GLSWID;
...
//	virtual int UserBlock( int nUserNum, int nDay );
	...
	*/
	...
	//add sw buff
	virtual int GetSwRegion(std::vector<GLTWID> &vSWID_DB) { return 0; }
    /**
