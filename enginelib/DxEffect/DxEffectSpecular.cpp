...
const DWORD	DxEffectSpecular::VERSION_SAVE = 0x00000100;
const char	DxEffectSpecular::NAME[] = "DxEffectSpecular";
...
void DxEffectSpecular::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectSpecular::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
