...
const DWORD	DxEffectSpecReflect::VERSION_SAVE = 0x00000100;
const char	DxEffectSpecReflect::NAME[] = "DxEffectSpecReflect";
...
void DxEffectSpecReflect::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectSpecReflect::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
