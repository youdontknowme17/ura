...
public:
	...
	void Load_EP9( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile, const char* pPieceName );
...
private:
	...
	static const DWORD VERSION_PSF_SAVE;
	static const DWORD VERSION_WLD_SAVE;
...
public:
	...
	void LoadWLD_EP9( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile );
