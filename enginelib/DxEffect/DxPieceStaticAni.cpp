...
DWORD	DxStaticAniFrame::VERSION_SAVE	= 0x0101;
...
void DxStaticAniFrame::Load( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxStaticAniFrame::Load Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwBufferSize,VERSION);
