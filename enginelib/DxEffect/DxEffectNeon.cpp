...
const DWORD	DxEffectNeon::VERSION_SAVE = 0x00000100;
const char	DxEffectNeon::NAME[] = "DxEffectNeon";
...
void DxEffectNeon::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectNeon::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
