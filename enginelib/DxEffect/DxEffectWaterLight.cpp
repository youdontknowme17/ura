...
const DWORD	DxEffectWaterLight::VERSION_SAVE = 0x00000101;
const char DxEffectWaterLight::NAME[] = "DxEffectWaterLight";
...
void DxEffectWaterLight::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectWaterLight::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
