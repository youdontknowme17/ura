...
const DWORD	DxEffectSpecular2::VERSION_SAVE = 0x00000100;
const char	DxEffectSpecular2::NAME[] = "DxEffectSpecular2";
...
void DxEffectSpecular2::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectSpecular2::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
