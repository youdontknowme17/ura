...
const DWORD DxEffectWater2::VERSION_SAVE = 0x00000100;	
const char DxEffectWater2::NAME[] = "DxEffectWater2";
...
void DxEffectWater2::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectWater2::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
