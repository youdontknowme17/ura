...
const DWORD	DxEffectFur::VERSION_SAVE = 0x00000100;
const char DxEffectFur::NAME[] = "DxEffectFur";
...
void DxEffectFur::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	else
	{
		...
		CString strTemp = "";
		strTemp.Format( "DxEffectFur::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
