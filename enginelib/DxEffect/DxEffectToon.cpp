...
const DWORD	DxEffectToon::VERSION_SAVE = 0x00000100;
const char DxEffectToon::NAME[] = "DxEffectToon";
...
void DxEffectToon::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectToon::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
