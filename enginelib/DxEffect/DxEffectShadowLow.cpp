...
const DWORD	DxEffectShadowLow::VERSION_SAVE = 0x106;
const char	DxEffectShadowLow::NAME[] = "DxEffectShadowLow";
...
void DxEffectShadowLow::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	else if ( dwVer==0x101 && dwSize==sizeof(SHADOW_PROPERTY_L_101_102) )
	{		
		SHADOW_PROPERTY_L_101_102 _pProp = *((SHADOW_PROPERTY_L_101_102*)pProp);
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectShadowLow::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
