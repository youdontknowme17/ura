...
const DWORD	DxEffectGlow::VERSION_SAVE = 0x00000100;
const char DxEffectGlow::NAME[] = "DxEffectGlow";
...
void DxEffectGlow::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	else
	{
		...
		CString strTemp = "";
		strTemp.Format( "DxEffectGlow::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
