...
const DWORD	DxTexEffRotate::VERSION_SAVE = 0x00000100;
const char DxTexEffRotate::NAME[] = "DxTexEffRotate";
...
void DxTexEffRotate::LoadPSF( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxTexEffRotate::LoadPSF Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
