...
public:
	...
	VEC_BONELINE	GetLine2BoneLine() {return m_vecBoneLINE; }
	VEC_BONEINF	GetLine2BoneInf() {return m_vecBoneINF; }
	void ClearAllBoneLine() { m_vecBoneLINE.clear(); }
...
public:
	...
	//add upgradeeffect
	HRESULT NewGrind_A ( int nType,int nGrind, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT NewGrind_B ( int nType,int nGrind, LPDIRECT3DDEVICEQ pd3dDevice );
