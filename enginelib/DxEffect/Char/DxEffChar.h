...
public:
	...
	virtual DWORD					GetMaterialNum()				{ return 0;	}
	...
	virtual HRESULT LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice ,bool bTool ,bool bRan2 ) = 0;
	virtual HRESULT SaveFile ( basestream &SFile ,bool bTool) = 0;
