...
const DWORD	DxEffectLightMap::VERSION_SAVE = 0x00000100;
const char DxEffectLightMap::NAME[] = "DxEffectLightMap";
...
void DxEffectLightMap::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectLightMap::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
