...
const DWORD	DxEffectMultiTex::VERSION_SAVE = 0x00000101;
const char	DxEffectMultiTex::NAME[] = "DxEffectMultiTex";
...
void DxEffectMultiTex::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectMultiTex::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
