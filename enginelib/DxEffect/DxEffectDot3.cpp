...
const DWORD	DxEffectDot3::VERSION_SAVE = 0x00000100;
const char DxEffectDot3::NAME[] = "DxEffectDot3";
...
void DxEffectDot3::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectDot3::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
