...
const DWORD	DxStaticMesh::VERSION_SAVE	= 0x0102;
...
void DxStaticMesh::Load( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile, const BOOL bDynamicLoad, const BOOL bPiece )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxStaticMesh::Load Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwBufferSize,VERSION);
