...
const DWORD	DxEffectNature::VERSION_SAVE = 0x00000101;
const char DxEffectNature::NAME[] = "DxEffectNature";
...
void DxEffectNature::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectNature::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
