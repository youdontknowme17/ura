...
const DWORD	DxEffectWater::VERSION_SAVE = 0x00000101;
const char DxEffectWater::NAME[] = "DxEffectWater";
...
void DxEffectWater::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectWater::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
