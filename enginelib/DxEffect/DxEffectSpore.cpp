...
const DWORD	DxEffectSpore::VERSION_SAVE = 0x00000101;
const char DxEffectSpore::NAME[] = "DxEffectSpore";
...
void DxEffectSpore::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffectSpore::SetProperty Error! Version:%d Size:%d Current Version:%d" 		,dwVer
		,dwSize
		,VERSION
		);
