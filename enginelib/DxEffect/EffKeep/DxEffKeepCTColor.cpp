...
DWORD		DxEffKeepData_CTColor::VERSION_SAVE		= 0x0100;
char		DxEffKeepData_CTColor::NAME[64]			= "EffKeepData_CTColor";
...
HRESULT	DxEffKeepData_CTColor::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffKeepData_CTColor::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
