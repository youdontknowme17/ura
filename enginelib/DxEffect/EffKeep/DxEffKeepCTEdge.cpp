...
DWORD		DxEffKeepData_CTEdge::VERSION_SAVE		= 0x0100;
char		DxEffKeepData_CTEdge::NAME[64]			= "EffKeepData_CTEdge";
...
HRESULT	DxEffKeepData_CTEdge::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxEffKeepData_CTEdge::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
