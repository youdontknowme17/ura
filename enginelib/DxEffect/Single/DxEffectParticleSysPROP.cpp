...
const DWORD	PARTICLESYS_PROPERTY::VERSION_SAVE		= 0x0106;
const char	PARTICLESYS_PROPERTY::NAME[]			= "PARTICLESYS_PROPERTY";
...
HRESULT PARTICLESYS_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "PARTICLESYS_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
