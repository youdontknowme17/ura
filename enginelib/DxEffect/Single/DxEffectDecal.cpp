...
const DWORD	DECAL_PROPERTY::VERSION_SAVE	= 0x0101;
const char	DECAL_PROPERTY::NAME[]			= "DECAL_PROPERTY";
...
HRESULT DECAL_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DECAL_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectDecal::NAME[]		= "DxEffectDecal";
