...
const DWORD	GROUND_PROPERTY::VERSION_SAVE		= 0x0102;
const char	GROUND_PROPERTY::NAME[]				= "GROUND_PROPERTY";
...
HRESULT GROUND_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "GROUND_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectGround::NAME[]		= "DxEffectGround";
