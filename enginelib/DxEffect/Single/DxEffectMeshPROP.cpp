...
const DWORD MESH_PROPERTY::VERSION_SAVE = 0x0105;
const char	MESH_PROPERTY::NAME[]		= "MESH_PROPERTY";
...
HRESULT MESH_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "MESH_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
