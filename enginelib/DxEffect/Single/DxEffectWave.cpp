...
const DWORD	WAVE_PROPERTY::VERSION_SAVE	= 0x0104;
const char	WAVE_PROPERTY::NAME[]		= "WAVE_PROPERTY";
...
HRESULT WAVE_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "WAVE_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectWave::NAME[]	= "DxEffectWave";
