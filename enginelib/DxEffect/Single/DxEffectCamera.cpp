...
const DWORD	CAMERA_PROPERTY::VERSION_SAVE	= 0x0101;
...
HRESULT CAMERA_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "CAMERA_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectCamera::NAME[]	= "DxEffectCamera";
