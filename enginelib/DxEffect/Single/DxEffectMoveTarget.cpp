...
const DWORD	MOVETARGET_PROPERTY::VERSION_SAVE		= 0x0101;
const char	MOVETARGET_PROPERTY::NAME[]				= "MOVETARGET_PROPERTY";
...
HRESULT MOVETARGET_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "MOVETARGET_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectMoveTarget::NAME[]	= "DxEffectMoveTarget";
