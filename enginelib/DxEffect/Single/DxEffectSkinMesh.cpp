...
const DWORD SKINMESH_PROPERTY::VERSION_SAVE = 0x0101;
const char	SKINMESH_PROPERTY::NAME[]		= "SKINMESH_PROPERTY";
...
HRESULT SKINMESH_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "SKINMESH_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char DxEffectSkinMesh::NAME[] = "DxEffectSkinMesh";
