...
const DWORD	MOVEROTATE_PROPERTY::VERSION_SAVE		= 0x0103;
const char	MOVEROTATE_PROPERTY::NAME[]				= "MOVEROTATE_PROPERTY";
...
HRESULT MOVEROTATE_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "MOVEROTATE_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectMoveRotate::NAME[]		= "DxEffectMoveRotate";
