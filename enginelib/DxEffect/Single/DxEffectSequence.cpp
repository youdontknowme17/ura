...
const DWORD	SEQUENCE_PROPERTY::VERSION_SAVE	= 0x0102;
...
HRESULT SEQUENCE_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "SEQUENCE_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectSequence::NAME[]	= "DxEffectSequence";
