...
const DWORD	POINTLIGHT_PROPERTY::VERSION_SAVE	= 0x0101;
const char	POINTLIGHT_PROPERTY::NAME[]			= "POINTLIGHT_PROPERTY";
...
HRESULT POINTLIGHT_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "POINTLIGHT_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectPointLight::NAME[]		= "DxEffectPointLight";
