...
const DWORD	BLURSYS_PROPERTY::VERSION_SAVE	= 0x0102;
const char	BLURSYS_PROPERTY::NAME[]		= "BLURSYS_PROPERTY";
...
HRESULT BLURSYS_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "BLURSYS_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectBlurSys::NAME[]	= "DxEffectBlurSys";
