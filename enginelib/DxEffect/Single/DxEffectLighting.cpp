...
const DWORD	LIGHTNING_PROPERTY::VERSION_SAVE	= 0x0102;
const char	LIGHTNING_PROPERTY::NAME[]			= "LIGHTNING_PROPERTY";
...
HRESULT LIGHTNING_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CString strTemp = "";
		strTemp.Format( "LIGHTNING_PROPERTY::LoadFile Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
...
const char	DxEffectLightning::NAME[]	= "DxEffectLightning";
