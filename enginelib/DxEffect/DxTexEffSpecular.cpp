...
const DWORD	DxTexEffSpecular::VERSION_SAVE	= 0x00000100;
const char DxTexEffSpecular::NAME[] = "DxTexEffSpecular";
...
void DxTexEffSpecular::LoadPSF( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile )
{
	...
	if( dwVer==VERSION || dwVer==0x00000101 )
	{
	...
	{
		CString strTemp = "";
		strTemp.Format( "DxTexEffSpecular::LoadPSF Error! Name:%s Version:%d Size:%d Current Version:%d" ,SFile.GetFileName(),dwVer,dwSize,VERSION);
