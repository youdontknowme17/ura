		...
		case 1: //abl edit
			{
				...
				if ( m_pSkinChar->m_pSkinCharPiece[ nEditPiece ] ) 
				{
					...
					case 0: //free stance
						{
							fRotX = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_fRotX_F;
							fRotY = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_fRotY_F;
							fRotZ = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_fRotZ_F;

							fPosX = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_vVelocityPiece_F.x;
							fPosY = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_vVelocityPiece_F.y;
							fPosZ = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_vVelocityPiece_F.z;

							CDebugSet::ToView ( 2,3, "ABL Stance:Free" );
						}break;
					case 1: //attack stance
						{
							fRotX = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_fRotX;
							fRotY = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_fRotY;
							fRotZ = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_fRotZ;

							fPosX = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_vVelocityPiece.x;
							fPosY = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_vVelocityPiece.y;
							fPosZ = m_pSkinChar->m_pSkinCharPiece[nEditPiece]->m_vVelocityPiece.z;
