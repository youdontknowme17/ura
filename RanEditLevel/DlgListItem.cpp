...
//		if ( p->sBasicOp.dwReqCharClass&GLCC_ASSASIN_M )	str += "Assassin[M] | ";
//		if ( p->sBasicOp.dwReqCharClass&GLCC_ASSASIN_W )	str += "Assassin[W] | ";
//		if ( p->sBasicOp.dwReqCharClass&GLCC_TESTING_M )	str += "Tricker[M] | ";
//		if ( p->sBasicOp.dwReqCharClass&GLCC_TESTING_W )	str += "Tricker[W] | ";
