...
void CSystemInfo::GetProcessorName(char* szPname)
{
	...
	case 15 : // Family code 1111
		...
		break; */
	default :
		StringCchCopy(szPname, MAX_PROCESSOR_NAME, _T("Multi Core Processor Detected"));
		break;
	}
}
...
void CSystemInfo::GetOSName(char* szName)
{
	...
	case VER_PLATFORM_WIN32_NT:
		...
		if ((OSInfo.dwMajorVersion == 6) && (OSInfo.dwMinorVersion == 1))
			StringCchCopy(szName, MAX_OS_NAME, _T("Microsoft Windows 7 or Windows Server 2008 R2"));
		// Microsoft Windows 2008
		if ((OSInfo.dwMajorVersion == 6) && (OSInfo.dwMinorVersion == 0))
			StringCchCopy(szName, MAX_OS_NAME, _T("Microsoft Windows Vista or Windows Server 2008"));
		
		// Microsoft Windows 2003
		if ((OSInfo.dwMajorVersion == 5) && (OSInfo.dwMinorVersion == 2))
			StringCchCopy(szName, MAX_OS_NAME, _T("Microsoft Windows XP x64 or Windows Server 2003"));

		// Microsoft Windows XP
		if ((OSInfo.dwMajorVersion == 5) && (OSInfo.dwMinorVersion == 1))
			StringCchCopy(szName, MAX_OS_NAME, _T("Microsoft Windows XP x86"));
