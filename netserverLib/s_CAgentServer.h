...
#include "../RanClientLib/DbActionLogic.h"
#include "../RanClientLib/DxServerInstance.h"
#include "../RanClientLib/G-Logic/GLChar.h"
#include "../RanClientLib/G-Logic/GLContrlMsg.h"
#include "../RanClientLib/G-Logic/GLAgentServer.h"
...
public:
	// MsgSndRegisterAccount
	// MsgSndRegisterAccountBack
	void MsgSndRegisterAccount(MSG_LIST* pMsg);
	void MsgSndRegisterAccountBack(
		int nResult,
		DWORD dwClient,
		const TCHAR* szUserIP,
		USHORT uPort
	...
	// MsgSndForgotAccount
	// MsgSndForgotAccountBack
	void MsgSndForgotAccount(MSG_LIST* pMsg);
	void MsgSndForgotAccountBack(
		int nResult,
		DWORD dwClient,
		const TCHAR* szUserIP,
		USHORT uPort
	...
	// MsgSndChangePassword
	// MsgSndChangePasswordBack
	void MsgSndChangePassword(MSG_LIST* pMsg);
	void MsgSndChangePasswordBack(
		int nResult,
		DWORD dwClient,
		const TCHAR* szUserIP,
		USHORT uPort
	...
	// MsgChangePinCode
	void MsgSndChangePinCode(MSG_LIST* pMsg);
	void MsgSndChangePinCodeBack(
		int nResult,
		DWORD dwClient,
		const TCHAR* szUserIP,
		USHORT uPort
	...
	// MsgSndFixUser
	// MsgSndFixUserBack
	void MsgSndFixUser(MSG_LIST* pMsg);
	void MsgSndFixUserBack(
		int nResult,
		DWORD dwClient,
		const TCHAR* szUserIP,
		USHORT uPort
...
public:
	// MsgSndGenVoc
	// MsgSndGenVocBack
	void MsgSndGenVoc(MSG_LIST* pMsg);
	void MsgSndGenVocBack(
		int nResult,
		DWORD dwClient,
		const TCHAR* szUserIP,
		USHORT uPort
	...
	// MsgSndSrchVoc
	// MsgSndSrchVocBack
	void MsgSndSrchVoc(MSG_LIST* pMsg);
	void MsgSndSrchVocBack(
		int nResult,
		DWORD dwClient,
		const TCHAR* szUserIP,
		USHORT uPort
	...
	// TopUp
	void MsgSndTopUp(MSG_LIST* pMsg);
	void MsgSndTopUpBack(
		STOPUP* sTopUp,
		int nResult,
		DWORD dwClient,
		const TCHAR* szUserIP,
