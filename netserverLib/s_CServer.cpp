...
{	
	...
	nRetCode = CCfg::GetInstance()->Load(_T("svr_session_0.ini"));
	if (nRetCode != 0)
	{
		CConsoleMessage::GetInstance()->Write(_T("ERROR:Session Server Configuration ini files not found. Please Check CFG Folder"));
		m_bIsRunning = false;
		return NET_ERROR;
	}	
...
{	
	...
	nRetCode = CCfg::GetInstance()->Load(_T("svr_login_0.ini"));
	if (nRetCode != 0)
	{
		CConsoleMessage::GetInstance()->Write(_T("ERROR:Login Server Configuration ini files not found. Please Check CFG Folder"));
		m_bIsRunning = false;
		return NET_ERROR;
	}	
...
{	
	...
	nRetCode = CCfg::GetInstance()->Load(_T("svr_field_0.ini"));
	if (nRetCode != 0)
	{
		CConsoleMessage::GetInstance()->Write(_T("ERROR:Field Server Configuration ini files not found. Please Check CFG Folder"));
		m_bIsRunning = false;
		return NET_ERROR;
	}	
...
{	
	...
	nRetCode = CCfg::GetInstance()->Load(_T("svr_agent_0.ini"));
	if (nRetCode != 0)
	{
		CConsoleMessage::GetInstance()->Write(_T("ERROR:Agent Server Configuration ini files not found. Please Check CFG Folder"));
		m_bIsRunning = false;
		return NET_ERROR;
	}	
