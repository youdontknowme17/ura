...
// RegisterAccount
class CAgentRegisterAccount : public CDbAction
{
public:
	CAgentRegisterAccount(
...
protected:
	...
	CString m_strEmail;
	CString m_strCaptcha1;
	int m_nRandomNum;
	int m_nPort;
};

// ForgotPassword
class CAgentForgotAccount : public CDbAction
{
public:
	CAgentForgotAccount(
		const TCHAR* szEmail,
...
// ChangePassword
class CAgentChangePassword : public CDbAction
{
public:
	CAgentChangePassword(
		const TCHAR* szUserID,
...
//ChangePinCode
class CAgentChangePinCode : public CDbAction
{
public:
	CAgentChangePinCode(
		const TCHAR* szUserID,
	...
	virtual ~CAgentChangePinCode() {};
	virtual int Execute(CServer* pServer);

protected:
	CString m_strUserID;
	CString m_strPassw;
	CString m_strOldPinCode;
	CString m_strNewPinCode;
	CString m_strCaptcha1;
	int m_nRandomNum;
	int m_nPort;
};
...
// FixUser
class CAgentFixUser : public CDbAction
{
public:
	CAgentFixUser(
		const TCHAR* szUserID,
...
// CAgentSndGenVoc
class CAgentSndGenVoc : public CDbAction
{
public:
	CAgentSndGenVoc(
		const TCHAR* szUserID,
	...
	virtual ~CAgentSndGenVoc() {};
	virtual int Execute(CServer* pServer);

protected:
	CString m_strUserID;
	CString m_strVocID;
	CString m_strVocCodes;
	CString m_strNominal;
	int m_nPort;
};

// SndSrchVoc
class CAgentSndSrchVoc : public CDbAction
{
public:
	CAgentSndSrchVoc(
		const TCHAR* szUserID,
...
// TopUp
class CAgentTopUp : public CDbAction
{
protected:
	STOPUP sTopUp;
