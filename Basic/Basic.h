...
#if defined( PH_PARAM ) 
#include "../=include_th/NPGameLib.h"
#else
#include "../=include/NPGameLib.h"
#endif
...
protected:
    ...
    BOOL		bInitialize;
    BOOL		bMonitoring;
	BOOL HS_InitializeService( BOOL bMonitor );
	BOOL HS_MakeResponse( BOOL bMonitor );
	BOOL HS_StartService( BOOL bMonitor );
	BOOL HS_InitializeService2( BOOL bMonitor );
	BOOL HS_StartService2( BOOL bMonitor );
