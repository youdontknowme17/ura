...
{
	//game protection for wpe,ce,razer keyboards macro and other autopots
	HMODULE hModule = LoadLibrary(TEXT("einal.dll"));
...
//		RANPARAM::emSERVICE_TYPE==EMSERVICE_JAPAN ||	// JAPAN 로그인 방식 변경
	...
	if ( !bAPM )
	{
		MessageBox ( NULL, "Use Launcher To Play Ran Online!", "KB Development", MB_OK );
		return FALSE;
	}
	#endif // !NDEBUG
