...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndDlgBar.Create(this, IDD_DIALOG_MAIN, 
		CBRS_RIGHT | CBRS_GRIPPER | CBRS_TOOLTIPS | CBRS_FLYBY, ID_VIEW_EDITBAR ))
	{
	...
	m_pToolTab = new CToolTab ( CRect(0, 0, 700, 780), logfont, &m_wndDlgBar );
...
void CMainFrame::DataUpdate()
{
	m_pToolTab->ActiveDlgPage( DLG_MAIN );
}

void CMainFrame::DataReset()
{
