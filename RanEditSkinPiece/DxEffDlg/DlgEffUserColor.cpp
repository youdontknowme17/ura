// DlgEffUserColor.cpp : implementation file
//

#include "stdafx.h"
#include "../RanEditSkinPiece.h"
#include "DlgEffUserColor.h"
...
IMPLEMENT_DYNAMIC(CDlgEffUserColor, CPropertyPage)
CDlgEffUserColor::CDlgEffUserColor( LOGFONT logfont )
	: CPropertyPage(CDlgEffUserColor::IDD)
	, m_pFont( NULL )
	, m_pPiece( NULL )
	, bNEWEFF( FALSE )
	, m_nMatEdit( -1 )
...
CDlgEffUserColor::~CDlgEffUserColor()
{
}

void CDlgEffUserColor::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgEffUserColor, CPropertyPage)
...
// CDlgEffUserColor message handlers
BOOL CDlgEffUserColor::OnInitDialog()
{
...
void CDlgEffUserColor::SetData( DxSkinPiece* pData, DxEffCharUserColor* pEff, BOOL bNEW )
{
	if ( pData ) 
	{
		m_pPiece = NULL;
...
void CDlgEffUserColor::ShowData()
{
	if ( m_pPiece && m_pEff )
	{
		EFFCHAR_PROPERTY_USERCOLOR* pProperty = (EFFCHAR_PROPERTY_USERCOLOR*) m_pEff->GetProperty();
		if ( pProperty )
		{
			SetWin_Num_float( this, IDC_EDIT_COLOR_A, pProperty->m_cColor.a );
			SetWin_Num_float( this, IDC_EDIT_COLOR_R, pProperty->m_cColor.r );
			SetWin_Num_float( this, IDC_EDIT_COLOR_G, pProperty->m_cColor.g );
			SetWin_Num_float( this, IDC_EDIT_COLOR_B, pProperty->m_cColor.b );
...
void CDlgEffUserColor::ShowMaterialList()
{
	if ( m_pPiece && m_pEff )
	{
		EFFCHAR_PROPERTY_USERCOLOR* pProperty = (EFFCHAR_PROPERTY_USERCOLOR*) m_pEff->GetProperty();
...
BOOL CDlgEffUserColor::SaveData()
{
	if ( m_pPiece && m_pEff )
	{
		EFFCHAR_PROPERTY_USERCOLOR Property;
		Property.m_cColor.a = GetWin_Num_float( this, IDC_EDIT_COLOR_A );
		Property.m_cColor.r = GetWin_Num_float( this, IDC_EDIT_COLOR_R );
		Property.m_cColor.g = GetWin_Num_float( this, IDC_EDIT_COLOR_G );
		Property.m_cColor.b = GetWin_Num_float( this, IDC_EDIT_COLOR_B );
...
void CDlgEffUserColor::OnBnClickedButtonDlgeffApply()
{
	if ( m_pPiece && m_pEff )
	{
		if ( SaveData() )
...
void CDlgEffUserColor::OnBnClickedButtonDlgeffSave()
{
	if ( SaveData() )
	{
		m_pPiece = NULL;
...
void CDlgEffUserColor::OnBnClickedButtonDlgeffCancel()
{
	if ( m_pToolTab )
	{
		m_pPiece = NULL;
...
void CDlgEffUserColor::OnBnClickedButtonSpecular()
{
...
void CDlgEffUserColor::OnBnClickedButtonSpecularOk()
{
...
void CDlgEffUserColor::OnNMDblclkListSpecular(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CDlgEffUserColor::OnBnClickedButtonColor()
{
