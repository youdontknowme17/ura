...
class CDlgEffNormalMap : public CPropertyPage
{
	DECLARE_DYNAMIC(CDlgEffNormalMap)

public:
	CDlgEffNormalMap( LOGFONT logfont );
	virtual ~CDlgEffNormalMap();

// Dialog Data
	enum { IDD = IDD_DLG_EFF_NORMALMAP };
...
public:
	...
	void			SetData( DxSkinPiece* pData, DxEffCharNormal* pEff, BOOL bNEW );
	void			ShowData();
	BOOL			SaveData();
