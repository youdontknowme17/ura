...
#define VOC_ID_LENGTH				10
#define VOC_CODES_LENGTH			14
...
// RegisterAccount
enum EM_REGISTERACCOUNT_FB_SUB
{
	EM_REGISTERACCOUNT_FB_SUB_FAIL			= 0,
	EM_REGISTERACCOUNT_FB_SUB_INCORRECT		= 1,
	EM_REGISTERACCOUNT_FB_SUB_RANDOM_PASS	= 2,
	EM_REGISTERACCOUNT_FB_SUB_OK			= 3,
	EM_REGISTERACCOUNT_FB_SUB_INUSE_EMAIL	= 4 //Add by mcalimosa 09/08/2018
};

// ForgotAccount
enum EM_FORGOTACCOUNT_FB_SUB
{
	EM_FORGOTACCOUNT_FB_SUB_FAIL		= 0,
	EM_FORGOTACCOUNT_FB_SUB_INCORRECT	= 1,
	EM_FORGOTACCOUNT_FB_SUB_RANDOM_PASS = 2,
	EM_FORGOTACCOUNT_FB_SUB_OK			= 3
};

// ChangePassword
enum EM_CHANGEPASSWORD_FB_SUB
{
	EM_CHANGEPASSWORD_FB_SUB_FAIL			= 0,
	EM_CHANGEPASSWORD_FB_SUB_INCORRECT		= 1,
	EM_CHANGEPASSWORD_FB_SUB_RANDOM_PASS	= 2,
	EM_CHANGEPASSWORD_FB_SUB_OK				= 3
};

// ChangePinCode
enum EM_CHANGEPINCODE_FB_SUB
{
	EM_CHANGEPINCODE_FB_SUB_FAIL = 0,
	EM_CHANGEPINCODE_FB_SUB_INCORRECT = 1,
	EM_CHANGEPINCODE_FB_SUB_RANDOM_PIN = 2,
	EM_CHANGEPINCODE_FB_SUB_OK = 3
};

// FixUser
enum EM_FIXUSER_FB_SUB
{
	EM_FIXUSER_FB_SUB_FAIL			= 0,
	EM_FIXUSER_FB_SUB_INCORRECT		= 1,
	EM_FIXUSER_FB_SUB_RANDOM_PASS	= 2,
	EM_FIXUSER_FB_SUB_OK			= 3
};
...
// SndGenVoc
enum EM_SNDGENVOC_FB_SUB
{
	EM_SNDGENVOC_FB_SUB_FAIL = 0,
	EM_SNDGENVOC_FB_SUB_OK = 1
};

// SndSrchVoc
enum EM_SNDSRCHVOC_FB_SUB
{
	EM_SNDSRCHVOC_FB_SUB_FAIL				= 0,
	EM_SNDSRCHVOC_FB_SUB_NONE				= 1,
	EM_SNDSRCHVOC_FB_SUB_USERID_UNCLAIMED	= 2,
	EM_SNDSRCHVOC_FB_SUB_USERID_CLAIMED		= 3,
	EM_SNDSRCHVOC_FB_SUB_VOCID_UNCLAIMED	= 4,
	EM_SNDSRCHVOC_FB_SUB_VOCID_CLAIMED		= 5
};
...
{
	EM_TOPUP_FB_SUB_FAIL			= 0,
	EM_TOPUP_FB_SUB_INCORRECT		= 1,
	EM_TOPUP_FB_SUB_USED			= 2,
	EM_TOPUP_FB_SUB_CAPTCHA			= 3,
	EM_TOPUP_FB_SUB_OK				= 4,
};
...
//
#if defined(CH_PARAM)
	#define NET_MSG_BASE				1016				  // 기본 메시지
#elif defined(HK_PARAM)
	#define NET_MSG_BASE				1004				  // 기본 메시지
#elif defined(ID_PARAM)
	#define NET_MSG_BASE				974					  // 기본 메시지
#elif defined(JP_PARAM)
	#define NET_MSG_BASE				1028				  // 기본 메시지
#elif defined(KR_PARAM)
	#define NET_MSG_BASE				984					  // 기본 메시지
#elif defined(KRT_PARAM)
	#define NET_MSG_BASE				968					  // 기본 메시지
#elif defined(MY_PARAM)
	#define NET_MSG_BASE				967					  // 기본 메시지
#elif defined(MYE_PARAM)
	#define NET_MSG_BASE				1002				  // 기본 메시지
#elif defined(PH_PARAM)
	#define NET_MSG_BASE				1014				  // 기본 메시지
#elif defined(VN_PARAM)
	#define NET_MSG_BASE				1018				  // 기본 메시지
#elif defined(TW_PARAM)
	#define NET_MSG_BASE				994					  // 기본 메시지
#elif defined(TH_PARAM)
	#define NET_MSG_BASE				986					  // 기본 메시지
#elif defined(GS_PARAM)
	#define NET_MSG_BASE				1001				  // 기본 메시지
#else
	#define NET_MSG_BASE				992					  // 기본 메시지
#endif
...
//	NET_MSG_APEX_RSAKEY				= (NET_MSG_GCTRL +	32), //< Apex RSA Key 메세지
	...
	NET_MSG_GCTRL_TOWER_DESTROYED_BRD	  = (NET_MSG_GCTRL + 783),	//<	cd 인증 BRD.
...
//-----------------------------------------------------------------------------------------------------------
	...
	///////////////////////////////////////////////////////////////////////
	//AutoPilot
	NET_MSG_GCTRL_REQ_USE_AUTO_SKILL		= (NET_MSG_GCTRL + 2128),	// ReqUseAutoSkill
	NET_MSG_GCTRL_UPDATE_USE_AUTO_SKILL		= (NET_MSG_GCTRL + 2129),	// UpdateUseAutoSkill
	///////////////////////////////////////////////////////////////////////
	...
	NET_MSG_REBUILD_SEALED_CARD						= (NET_MSG_GCTRL + 1862),

	NET_MSG_REBUILD_OPTION	                        = (NET_MSG_GCTRL + 1864),
	...
	NET_MSG_REBUILD_MOVE_SEAL 						= (NET_MSG_GCTRL + 1871), //sealed card 
	...
	NET_MSG_GCTRL_CROW_CHECK_TARGET					= (NET_MSG_GCTRL + 1952),
	NET_MSG_GCTRL_REQ_TARGET_ACQUIRE				= (NET_MSG_GCTRL + 1953),

	NET_MSG_GCTRL_REQ_LINKSKILLEFF_BRD		=	(NET_MSG_GCTRL + 1956),
	NET_MSG_GCTRL_REQ_LINKSKILLEFF_FB		=	(NET_MSG_GCTRL + 1957),
	NET_MSG_GCTRL_REQ_LINKSKILLEFF_CROW_BRD		=	(NET_MSG_GCTRL + 1958),
	NET_MSG_GCTRL_REQ_LINKSKILLEFF			=	(NET_MSG_GCTRL + 1959),

	NET_MSG_GCTRL_GLOBAL_SUCCESS_GRIND = (NET_MSG_GCTRL + 1960),

	NET_MSG_WPE_DT_BRD		                	= (NET_MSG_GCTRL + 1961), // 

	NET_MSG_REQ_CLUBWAR_REWARD_CLT					= (NET_MSG_GCTRL + 1962),	//add clubwar reward

	NET_MSG_GCTRL_TOWERWARS_PREVIOUS_RECORD		= (NET_MSG_GCTRL + 1963),
	NET_MSG_GCTRL_TOWERWARS_PREVIOUS_RECORD_FLD = (NET_MSG_GCTRL + 1964),
	NET_MSG_CTF_WIN									= (NET_MSG_GCTRL + 2015),
	NET_MSG_GCTRL_SCHOOLWAR_NEXTWAR_BRD				= (NET_MSG_GCTRL + 2017),
	NET_MSG_GCTRL_SCHOOLWAR_NEXTWAR_REQ				= (NET_MSG_GCTRL + 2018),
	NET_MSG_GCTRL_SERVER_NEXTWAR					= (NET_MSG_GCTRL + 2019),
	NET_MSG_GCTRL_REQ_TYRANNY_GETREWARD				= (NET_MSG_GCTRL + 2046),
	NET_MSG_GCTRL_REQ_TYRANNY_GETREWARD_FB			= (NET_MSG_GCTRL + 2047),
	NET_MSG_PVP_REJOIN		                    = (NET_MSG_GCTRL + 2070), //BattleFieldUI Data Rejoin - Eduj
	NET_MSG_PVP_REJOIN_BRD		                = (NET_MSG_GCTRL + 2071), //BattleFieldUI Data Rejoin - Eduj
	NET_MSG_GCTRL_TOWERWARS_WINNER_REQ	        = (NET_MSG_GCTRL + 2073), // Eduj Dev
	NET_MSG_GCTRL_TOWERWARS_SERVER_WINNER	    = (NET_MSG_GCTRL + 2074), // Eduj Dev
	NET_MSG_GCTRL_TOWERWARS_WINNER_PLAYER_UPDATE	    = (NET_MSG_GCTRL + 2075), // Eduj Dev

	NET_MSG_GCTRL_INVEN_POINT_SHOP			= (NET_MSG_GCTRL + 2076),	//< 아이템 조합 요청
	NET_MSG_GCTRL_INVEN_POINT_SHOP_FB			= (NET_MSG_GCTRL + 2077),	//< 아이템 조합 요청 결과

	////////////////////////////////////////////////////////////
	// RegisterAccount
	NET_MSG_REGISTERACCOUNT			= (NET_MSG_GCTRL + 2100),
	NET_MSG_REGISTERACCOUNT_FB		= (NET_MSG_GCTRL + 2101),

	// ForgotAccount
	NET_MSG_FORGOTACCOUNT			= (NET_MSG_GCTRL + 2102),
	NET_MSG_FORGOTACCOUNT_FB		= (NET_MSG_GCTRL + 2103),

	// ChangePassword
	NET_MSG_CHANGEPASSWORD			= (NET_MSG_GCTRL + 2104),
	NET_MSG_CHANGEPASSWORD_FB		= (NET_MSG_GCTRL + 2105),

	// ChangePinCode
	NET_MSG_CHANGEPINCODE			= (NET_MSG_GCTRL + 2106),
	NET_MSG_CHANGEPINCODE_FB		= (NET_MSG_GCTRL + 2107),
	// FixUser
	NET_MSG_FIXUSER					= (NET_MSG_GCTRL + 2108),
	NET_MSG_FIXUSER_FB				= (NET_MSG_GCTRL + 2109),

	////////////////////////////////////////////////////////////
	// Gmc

	// SndGenVoc
	NET_MSG_SNDGENVOC				= (NET_MSG_GCTRL + 2110),
	NET_MSG_SNDGENVOC_FB			= (NET_MSG_GCTRL + 2111),

	// SndSrchVoc
	NET_MSG_SNDSRCHVOC				= (NET_MSG_GCTRL + 2112),
	NET_MSG_SNDSRCHVOC_FB			= (NET_MSG_GCTRL + 2113),

	////////////////////////////////////////////////////////////
	// ItemMall

	// SndClaimVoc
	NET_MSG_TOPUP				= (NET_MSG_GCTRL + 2114),
	NET_MSG_TOPUP_FB			= (NET_MSG_GCTRL + 2115),
	// EPoint
	NET_MSG_GCTRL_REQ_TOPUP							= (NET_MSG_GCTRL + 2216),
	NET_MSG_GCTRL_UPDATE_EPOINT						= (NET_MSG_GCTRL + 2217),
};
...
// RegisterAccount
struct NET_REGISTERACCOUNT_DATA
{
	NET_MSG_GENERIC nmg;
	CHAR			szUserID	[USR_ID_LENGTH + 1];
	CHAR			szPassw		[USR_PASS_LENGTH + 1];
	CHAR			szPinCode	[USR_PASS_LENGTH + 1];
	CHAR			szEmail		[CHR_ID_LENGTH + 1];
	CHAR			szCaptcha1	[USR_RAND_PASS_LENGTH + 1];
	CHAR			szEnCrypt	[ENCRYPT_KEY + 1];

	NET_REGISTERACCOUNT_DATA()
	{
		nmg.dwSize = sizeof(NET_REGISTERACCOUNT_DATA);
		SecureZeroMemory(szUserID,		sizeof(CHAR) * (USR_ID_LENGTH + 1));
		SecureZeroMemory(szPassw,		sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szPinCode,		sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szEmail,		sizeof(CHAR) * (CHR_ID_LENGTH + 1));
		SecureZeroMemory(szCaptcha1,	sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szEnCrypt,		sizeof(CHAR) * (ENCRYPT_KEY + 1));
	}
};
typedef NET_REGISTERACCOUNT_DATA* LPNET_REGISTERACCOUNT_DATA;

struct NET_REGISTERACCOUNT_FB_DATA
{
	NET_MSG_GENERIC nmg;
	USHORT			nResult;

	NET_REGISTERACCOUNT_FB_DATA()
	{
		nmg.dwSize	= sizeof(NET_REGISTERACCOUNT_FB_DATA);
		nResult		= 0;
	}
};
typedef NET_REGISTERACCOUNT_FB_DATA* LPNET_REGISTERACCOUNT_FB_DATA;

// FORGOTACCOUNT
struct NET_FORGOTACCOUNT_DATA
{
	NET_MSG_GENERIC nmg;
	CHAR			szEmail		[CHR_ID_LENGTH + 1];
	CHAR			szPinCode	[USR_PASS_LENGTH + 1];
	...
	NET_FORGOTACCOUNT_DATA()
	{
		nmg.dwSize = sizeof(NET_FORGOTACCOUNT_DATA);
		SecureZeroMemory(szEmail,		sizeof(CHAR) * (CHR_ID_LENGTH + 1));
		SecureZeroMemory(szPinCode,		sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szCaptcha1,	sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szEnCrypt,		sizeof(CHAR) * (ENCRYPT_KEY + 1));
...
typedef NET_FORGOTACCOUNT_DATA* LPNET_FORGOTACCOUNT_DATA;

struct NET_FORGOTACCOUNT_FB_DATA
{
	NET_MSG_GENERIC nmg;
	USHORT			nResult;

	NET_FORGOTACCOUNT_FB_DATA()
	{
		nmg.dwSize	= sizeof(NET_FORGOTACCOUNT_FB_DATA);
		nResult		= 0;
	}
};
typedef NET_FORGOTACCOUNT_FB_DATA* LPNET_FORGOTACCOUNT_FB_DATA;

// ChangePassword
struct NET_CHANGEPASSWORD_DATA
{
	NET_MSG_GENERIC nmg;
	CHAR			szUserID	[USR_ID_LENGTH + 1];
	CHAR			szOldPassw	[USR_PASS_LENGTH + 1];
	CHAR			szNewPassw	[USR_PASS_LENGTH + 1];
	CHAR			szCaptcha1	[USR_RAND_PASS_LENGTH + 1];
	CHAR			szEnCrypt	[ENCRYPT_KEY + 1];

	NET_CHANGEPASSWORD_DATA()
	{
		nmg.dwSize = sizeof(NET_CHANGEPASSWORD_DATA);
		SecureZeroMemory(szUserID,		sizeof(CHAR) * (USR_ID_LENGTH + 1));
		SecureZeroMemory(szOldPassw,	sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szNewPassw,	sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szCaptcha1,	sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szEnCrypt,		sizeof(CHAR) * (ENCRYPT_KEY + 1));
	}
};
typedef NET_CHANGEPASSWORD_DATA* LPNET_CHANGEPASSWORD_DATA;

struct NET_CHANGEPASSWORD_FB_DATA
{
	NET_MSG_GENERIC nmg;
	USHORT			nResult;

	NET_CHANGEPASSWORD_FB_DATA()
	{
		nmg.dwSize	= sizeof(NET_CHANGEPASSWORD_FB_DATA);
		nResult		= 0;
	}
};
typedef NET_CHANGEPASSWORD_FB_DATA* LPNET_CHANGEPASSWORD_FB_DATA;

// Change PinCode
struct NET_CHANGEPINCODE_DATA
{
	NET_MSG_GENERIC nmg;
	CHAR			szUserID[USR_ID_LENGTH + 1];
	CHAR			szPassw[USR_PASS_LENGTH + 1];
	CHAR			szOldPinCode[USR_PASS_LENGTH + 1];
	CHAR			szNewPinCode[USR_PASS_LENGTH + 1];
	CHAR			szCaptcha1[USR_RAND_PASS_LENGTH + 1];
	CHAR			szEnCrypt[ENCRYPT_KEY + 1];

	NET_CHANGEPINCODE_DATA()
	{
		nmg.dwSize = sizeof(NET_CHANGEPINCODE_DATA);
		SecureZeroMemory(szUserID, sizeof(CHAR) * (USR_ID_LENGTH + 1));
		SecureZeroMemory(szPassw,  sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szOldPinCode, sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szNewPinCode, sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szCaptcha1, sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szEnCrypt, sizeof(CHAR) * (ENCRYPT_KEY + 1));
	}
};
typedef NET_CHANGEPINCODE_DATA* LPNET_CHANGEPINCODE_DATA;

struct NET_CHANGEPINCODE_FB_DATA
{
	NET_MSG_GENERIC nmg;
	USHORT			nResult;

	NET_CHANGEPINCODE_FB_DATA()
	{
		nmg.dwSize = sizeof(NET_CHANGEPINCODE_FB_DATA);
		nResult = 0;
	}
};
typedef NET_CHANGEPINCODE_FB_DATA* LPNET_CHANGEPINCODE_FB_DATA;

// FixUser
struct NET_FIXUSER_DATA
{
	NET_MSG_GENERIC nmg;
	CHAR			szUserID	[USR_ID_LENGTH + 1];
	CHAR			szPassw		[USR_PASS_LENGTH + 1];
	...
	NET_FIXUSER_DATA()
	{
		nmg.dwSize = sizeof(NET_FIXUSER_DATA);
		SecureZeroMemory(szUserID,		sizeof(CHAR) * (USR_ID_LENGTH + 1));
		SecureZeroMemory(szPassw,		sizeof(CHAR) * (USR_PASS_LENGTH + 1));
		SecureZeroMemory(szCaptcha1,	sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szEnCrypt,		sizeof(CHAR) * (ENCRYPT_KEY + 1));
...
typedef NET_FIXUSER_DATA* LPNET_FIXUSER_DATA;

struct NET_FIXUSER_FB_DATA
{
	NET_MSG_GENERIC nmg;
	USHORT			nResult;
	...
	NET_FIXUSER_FB_DATA()
	{
		nmg.dwSize	= sizeof(NET_FIXUSER_FB_DATA);
		nResult		= 0;
	}
};
typedef NET_FIXUSER_FB_DATA* LPNET_FIXUSER_FB_DATA;

///////////////////////////////////////////////////////////////////////////////
// Gmc

// SndGenVoc
struct NET_SNDGENVOC_DATA
{
	NET_MSG_GENERIC nmg;
	CHAR			szVocID[USR_ID_LENGTH + 1];
	CHAR			szVocCodes[USR_ID_LENGTH + 1];
	CHAR			szNominal[USR_RAND_PASS_LENGTH + 1];
	CHAR			szUserID[USR_ID_LENGTH + 1];
	CHAR			szEnCrypt[ENCRYPT_KEY + 1];

	NET_SNDGENVOC_DATA()
	{
		nmg.dwSize = sizeof(NET_SNDGENVOC_DATA);
		SecureZeroMemory(szVocID, sizeof(CHAR) * (USR_ID_LENGTH + 1));
		SecureZeroMemory(szVocCodes, sizeof(CHAR) * (USR_ID_LENGTH + 1));
		SecureZeroMemory(szNominal, sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szUserID, sizeof(CHAR) * (USR_ID_LENGTH + 1));
		SecureZeroMemory(szEnCrypt, sizeof(CHAR) * (ENCRYPT_KEY + 1));
	}
};
typedef NET_SNDGENVOC_DATA* LPNET_SNDGENVOC_DATA;

struct NET_SNDGENVOC_FB_DATA
{
	NET_MSG_GENERIC nmg;
	USHORT			nResult;

	NET_SNDGENVOC_FB_DATA()
	{
		nmg.dwSize = sizeof(NET_SNDGENVOC_FB_DATA);
		nResult = 0;
	}
};
typedef NET_SNDGENVOC_FB_DATA* LPNET_SNDGENVOC_FB_DATA;

// SndSrchVoc
struct NET_SNDSRCHVOC_DATA
{
	NET_MSG_GENERIC nmg;
	int				nSrchCode;
	CHAR			szInput		[USR_RAND_PASS_LENGTH + 1];
	CHAR			szUserID	[USR_ID_LENGTH + 1];
	CHAR			szEnCrypt	[ENCRYPT_KEY + 1];

	NET_SNDSRCHVOC_DATA()
	{
		nmg.dwSize = sizeof(NET_SNDSRCHVOC_DATA);
		nSrchCode = 0;
		SecureZeroMemory(szInput,	sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szUserID,	sizeof(CHAR) * (USR_ID_LENGTH + 1));
		SecureZeroMemory(szEnCrypt,	sizeof(CHAR) * (ENCRYPT_KEY + 1));
	}
};
typedef NET_SNDSRCHVOC_DATA* LPNET_SNDSRCHVOC_DATA;

struct NET_SNDSRCHVOC_FB_DATA
{
	NET_MSG_GENERIC nmg;
	USHORT			nResult;

	NET_SNDSRCHVOC_FB_DATA()
	{
		nmg.dwSize = sizeof(NET_SNDSRCHVOC_FB_DATA);
		nResult = 0;
	}
};
typedef NET_SNDSRCHVOC_FB_DATA* LPNET_SNDSRCHVOC_FB_DATA;
...
{
	NET_MSG_GENERIC nmg;
	CHAR			szVocID		[VOC_ID_LENGTH + 1];
	CHAR			szVocCodes	[VOC_CODES_LENGTH + 1];
	CHAR			szCaptcha1	[USR_RAND_PASS_LENGTH + 1];
	CHAR			szCaptcha2	[USR_RAND_PASS_LENGTH + 1];
	CHAR			szEnCrypt	[ENCRYPT_KEY + 1];

	NET_TOPUP()
	{
		nmg.dwSize = sizeof(NET_TOPUP);
		SecureZeroMemory(szVocID,		sizeof(CHAR) * (VOC_ID_LENGTH + 1));
		SecureZeroMemory(szVocCodes,	sizeof(CHAR) * (VOC_CODES_LENGTH + 1));
		SecureZeroMemory(szCaptcha1,	sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szCaptcha2,	sizeof(CHAR) * (USR_RAND_PASS_LENGTH + 1));
		SecureZeroMemory(szEnCrypt,		sizeof(CHAR) * (ENCRYPT_KEY + 1));
	}
};
typedef NET_TOPUP* LPNET_TOPUP;
...
public:
	...
	NET_TOPUP_FB()
		: m_lnSaldo(0)
	{
		nmg.dwSize = sizeof(NET_TOPUP_FB);
		nResult = 0;
	}
};
typedef NET_TOPUP_FB* LPNET_TOPUP_FB;

struct STOPUP
{
	char		m_szVocID		[VOC_ID_LENGTH];
	char		m_szVocCodes	[VOC_CODES_LENGTH];
	LONGLONG	m_lnSaldo;

	STOPUP()
		: m_lnSaldo(0)
	{
		memset(m_szVocID,		0, VOC_ID_LENGTH + 1);
		memset(m_szVocCodes,	0, VOC_CODES_LENGTH + 1);
	}
};
typedef STOPUP* PTOPUP;
