	...
	case NET_MSG_GCTRL_CONFRONT_FB:
		{
			...
			case EMCONFRONT_DIE_ME:
				...
				break;
			case EMCONFRONT_NO_BET:
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("EMCONFRONT_NO_BET") );
				break;
			case EMCONFRONT_CANT_BET:
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("EMCONFRONT_CANT_BET") );
				break;

			case EMCONFRONT_CANT_BET_MONEY:
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("EMCONFRONT_CANT_BET_MONEY") );
				break;

			case EMCONFRONT_CANT_BET_VOTEP:
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("EMCONFRONT_CANT_BET_VOTEP") );
				break;

			case EMCONFRONT_CANT_BET_PREMP:
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("EMCONFRONT_CANT_BET_PREMP") );
				break;
			};
