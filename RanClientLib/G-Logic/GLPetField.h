...
public:
	...
	bool CheckDoubleSkill(GLMSG::SNETPET_REQ_SKILLCHANGE* pNetMsg);
	HRESULT MsgLearnDualSkill ( NET_MSG_GENERIC* nmg );
	HRESULT MsgDualSkillChange ( NET_MSG_GENERIC* nmg );
};
