...
public:
	...
	void	ReqChangeActiveSkill2 ( SNATIVEID sSkillID );
	...
	void	ReqLearnSkill2( WORD wPosX, WORD wPosY );
	void	ReqLearnSkill2( DWORD dwChannel, WORD wPosX, WORD wPosY );
	void	ReqDualSkillPet( WORD wPosX, WORD wPosY );
	...
	void	MsgSkillChange1 ( NET_MSG_GENERIC* nmg );
	void	MsgSkillChange2 ( NET_MSG_GENERIC* nmg );
	...
	SNATIVEID GetActiveSkill1();
	SNATIVEID GetActiveSkill2();
	void	MsgDualSkillLearn( NET_MSG_GENERIC* nmg );

	// Skill Functions
	void	ProceedSkill ();
	void ProcessAutoUsePotSkill();

	void	ProceedSkill2();

	void ProcessPickSkill(int skillOrder);

	void	StartSkillProc ();
	void	StartSkillProc2 ();
