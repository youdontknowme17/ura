...
public:
	void NewTarget ( const STARGETID &sTargetID, BOOL bCheckMember = FALSE, bool bGroup = false );
...
public:
	...
	BOOL	IsStun();  //Transform Function 

public:
	void SetOwner( SW_SCHOOL_DATA emOWNER );
	BOOL	m_bCHECK;
	...
	bool	m_bFirstTime;
	bool	IsFirstTime() { return m_bFirstTime; }
	void	SetFirstTime(bool bFirst)  { m_bFirstTime = bFirst; }
