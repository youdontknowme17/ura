...
{
	EMR_OPT_NULL				= 0,
	EMR_OPT_DAMAGE_RATE			= 1,	//	공격력.
	EMR_OPT_DEFENSE_RATE		= 2,	//	방어력.
	EMR_OPT_HIT_RATE			= 3,	//	명중율.
	EMR_OPT_AVOID_RATE			= 4,	//	회피율.
	EMR_OPT_HP					= 5,	//	hp 증가.
	EMR_OPT_MP					= 6,	//	mp 증가.
	EMR_OPT_SP					= 7,	//	sp 증가.
	EMR_OPT_HP_INC_RATE			= 8,	//	hp 증가율.
	EMR_OPT_MP_INC_RATE			= 9,	//	mp 증가율.
	EMR_OPT_SP_INC_RATE			= 10,	//	sp 증가율.
	EMR_OPT_HMS_INC_RATE		= 11,	//	hp, mp, sp 증가율.
