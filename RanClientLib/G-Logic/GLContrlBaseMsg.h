...
enum EMCHAR_GATEOUT_FB
{
	...
	EMCHAR_GATEOUT_NOPARTY = 11,		//	Add remove party first before entering the map -
};
...
enum EMCONFRONT_FB
{
	...
	EMCONFRONT_CANT_BET_VOTEP		= 18, //add duel bet
	EMCONFRONT_CANT_BET_PREMP		= 19, //add duel bet
};
