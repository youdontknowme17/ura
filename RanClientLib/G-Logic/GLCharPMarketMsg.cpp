...
//#endif
	...
	//add money 2
	NetMsgM1.lnVoteP = m_lnVoteP;
	//add money 3
	NetMsgM1.lnPremP = m_lnPremP;
	//add contributionpoints by CNDev
	NetMsgM1.lnContribP = m_lnContribP;
	NetMsgM1.lnSaldo = m_lnSaldo;
	...
	//add money 2
	NetMsgM2.lnVoteP = pCHAR->m_lnVoteP;
	//add money 3
	NetMsgM2.lnPremP = pCHAR->m_lnPremP;
	//add contributionpoints by CNDev
	NetMsgM2.lnContribP = pCHAR->m_lnContribP;
	NetMsgM2.lnSaldo = m_lnSaldo;
