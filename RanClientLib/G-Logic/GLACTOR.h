...
public:
	...
	virtual DWORD	GetNowMP () const = 0;
	virtual DWORD	GetMaxMP () const = 0;

	virtual DWORD	GetNowSP () const = 0;
	virtual DWORD	GetMaxSP () const = 0;
	...
	virtual void ReceivePushPull ( const D3DXVECTOR3 &vMovePos, const bool bReact , const bool bAdjustSpeed , const float fSpeed, const bool bDash ) = 0; //add pushpull
