...
DWORD GLSummonField::ReceiveDamage ( const EMCROW emACrow, const DWORD dwAID, const DWORD dwDamage, const BOOL bShock )
{
	...
	//	Note : 공격 받을때 반응 감안?
	//		( emACrow, dwAID )
	DWORD wDxHP = GLSUMMON::RECEIVE_DAMAGE ( (DWORD) dwDamage );
...
void GLSummonField::ReceivePushPull ( const D3DXVECTOR3 &vMovePos, const bool bReact , const bool bAdjustSpeed , const float fSpeed, const bool bDash ) //add pushpull
{
