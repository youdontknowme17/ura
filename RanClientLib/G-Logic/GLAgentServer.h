...
struct SWorkingEvent
{
	...
	GLMSG::SNET_GM_SCHOOL_EVENT		 school_Event[3];	//add sw buff
	GLMSG::SNET_GM_EVENT_EX			 ex_Event;	
	GLMSG::SNET_GM_LIMIT_EVENT_BEGIN limit_Event;
	bool bWorkEvent[11];				 // 0 : 경험치, 1 : 아이템,  2 : 돈 드랍율, 3 : EX 이벤트,  4 : 리미트  5: 클래스별  경험치 6: 클래스별 아이템 7: 클래스별 돈
...
private:
	...
	BOOL MsgTowerWarsCertified ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	BOOL MsgTowerWarsDoBattleEnd ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	BOOL MsgTowerWarsLastCapture ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	...
	//add sw buff
	BOOL MsgGmEventSchoolEvent ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	...
	BOOL MsgCTFWinner ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	BOOL MsgCTFParticipate ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	BOOL MsgCTFRejoin ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	...
	BOOL MsgMove2Pos ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );

	BOOL MsgReqTyrannyParticipate ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	BOOL MsgGmWarningMSG ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID ); 
	//add tower down
	BOOL MsgGlobalSuccess ( NET_MSG_GENERIC* nmg );
	...
	BOOL MsgSchoolWarsRemainTime( NET_MSG_GENERIC* nmg );
	BOOL MsgRoyalRumbleRemainTime( NET_MSG_GENERIC* nmg );
	BOOL MsgClubCDCertifyIngBrd ( NET_MSG_GENERIC* nmg );
	BOOL MsgClubCDCertifyBrd ( NET_MSG_GENERIC* nmg );
	BOOL MsgAPDetectedBrd ( NET_MSG_GENERIC* nmg ); 	//add autopots detection
	BOOL MsgTowerWarsRemainTime( NET_MSG_GENERIC* nmg );
	...
	BOOL MsgTowerWarCapture( NET_MSG_GENERIC* nmg );

private:
	BOOL MsgWPEDetectedBrd ( NET_MSG_GENERIC* nmg ); 	// 

public:
	HRESULT MsgProcess ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );

	int  m_nCTFWINNER;
	int	 GetWinner() { return m_nCTFWINNER; }
