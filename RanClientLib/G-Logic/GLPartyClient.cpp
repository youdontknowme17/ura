...
BOOL GLPartyClient::MsgPartyLureFb ( NET_MSG_GENERIC* nmg )
{
	...
	case EMPARTY_LURE_ROYAL_MAP:
		CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("EMPARTY_LURE_ROYAL_MAP") );
		break;

	case EMPARTY_LURE_NO_TARGET:
		CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("EMPARTY_LURE_NO_TARGET") );
		break;
	};
