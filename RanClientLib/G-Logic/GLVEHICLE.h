...
//    EMPIECECHAR GetPieceFromSlot ( VEHICLE_ACCESSORYTYPE emType );
	...
	EMANI_MAINTYPE GetVehicleMainAni ( VEHICLE_TYPE	m_emTYPE);
	EMANI_SUBTYPE  GetVehicleSubAni ( EMANI_MAINTYPE m_emMainType ,bool bPassenger );
};
