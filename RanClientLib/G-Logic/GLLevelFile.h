...
#include "../../EngineLib/DxCommon/DxCustomTypes.h"
...
protected:
	...
	bool					m_bRedZone;//RedZone Integration SeiferXIII 2/11/14
	bool					m_bDomiWars;
	bool					m_bSchoolWars;
	bool					m_bRoyalRumble;
	bool					m_bTowerWars;
	bool					m_bCardActivity; //Added by JADev - Anti BP, SP during CW, SW and CDM
...
public:
	...
	bool IsCardActivity () const					{ return m_bCardActivity; } //Added by JADev - Anti BP, SP during CW, SW and CDM
	bool IsRedZone()	const					{ return m_bRedZone; }//RedZone Integration SeiferXIII 2/11/14
	bool IsDomiWars()	const					{ return m_bDomiWars; } // domiwars
	...
	void SetSchoolWarsZone ( bool bSchoolWars )	{ m_bSchoolWars = bSchoolWars; }
	void SetRoyalRumbleZone ( bool bRoyalRumble )	{ m_bRoyalRumble = bRoyalRumble; }
	void SetRedZone ( bool bRedZone )	{ m_bRedZone = bRedZone; }
	void SetClubDeathMatchZone ( bool bClubDeathMatch )	{ m_bClubDeathMatch = bClubDeathMatch; }
