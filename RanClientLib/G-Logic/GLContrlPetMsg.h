...
enum EMPET_REQ_DUAL_SKILL_FB
{
	EMPET_REQ_DUAL_SKILL_FB_FAIL	= 0,
	EMPET_REQ_DUAL_SKILL_FB_OK		= 1,
	EMPET_REQ_DUAL_SKILL_FB_NOITEM	= 2,
	EMPET_REQ_DUAL_SKILL_FB_BADITEM	= 3,
	EMPET_REQ_DUAL_SKILL_FB_ALREADY	= 4,
	EMPET_REQ_DUAL_SKILL_FB_INVALID_STORAGE	= 5,
	EMPET_REQ_DUAL_SKILL_FB_INVALID_SKILL = 6,
};
...
enum EMPET_SKILL_ORDER
{
	EMPET_SKILL_ORDER_FIRST				= 0,
	EMPET_SKILL_ORDER_SECOND			= 1,
};
...
namespace GLMSG
{
	...
	struct SNETPET_REQ_SKILLCHANGE
	{
		...
		SNATIVEID			sSkillID;
		EMPET_SKILL_ORDER   dSkillOrder;
		
		SNETPET_REQ_SKILLCHANGE () :
			sSkillID(NATIVEID_NULL()), 
			dSkillOrder(EMPET_SKILL_ORDER_FIRST)
		{
			nmg.dwSize = sizeof(*this);
	...
	struct SNETPET_ADD_SKILLFACT
	{
		...
		SKILL::EMTYPES		emTYPE2;
		float				fMVAR;
		float				fAge;
		EMPET_SKILL_ORDER	dwSkillOrder;

		SNETPET_ADD_SKILLFACT () :
			sNATIVEID(NATIVEID_NULL()),
			sNATIVEID2(NATIVEID_NULL()),
			emTYPE(SKILL::FOR_TYPE_SIZE),
			emTYPE2(SKILL::FOR_TYPE_SIZE),
			fMVAR(0.0f),
			fAge(0.0f),
			dwSkillOrder(EMPET_SKILL_ORDER_FIRST)
		{
			nmg.dwSize = sizeof(*this);
...
//-----------------------------------------------------------------------------------------------------
	...
	struct SNETPET_REQ_DUAL_SKILL
	{
		...
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_PET_DUAL_SKILL;
		}
	};

	struct SNETPET_REQ_DUAL_SKILL_FB
	{
		NET_MSG_GENERIC nmg;

		EMPET_REQ_DUAL_SKILL_FB		emFB;
		WORD						wPosX;
		WORD						wPosY;

		SNETPET_REQ_DUAL_SKILL_FB ()
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_PET_DUAL_SKILL_FB;
		}
	};

	struct SNETPET_REQ_DUAL_SKILL_BRD : public SNETPET_BROAD
	{
		BOOL	bDualSkill;
		SNETPET_REQ_DUAL_SKILL_BRD():
			bDualSkill(FALSE)
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_PET_DUAL_SKILL_BRD;
		}
	};

	struct SNETPET_DUAL_SKILL_UPDATE_FB
	{
		NET_MSG_GENERIC nmg;

		BOOL	bDualSkill;
		SNETPET_DUAL_SKILL_UPDATE_FB():
			bDualSkill(FALSE)
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_PET_DUAL_SKILL_UPDATE_FB;
		}
