...
namespace CROWCOLOR
{
	...
	const DWORD MOB_COLOR_ORANGE	= D3DCOLOR_ARGB(255,255,153,0);
};
namespace RANKCOLOR
{
	const DWORD RANK_COLOR_1 = D3DCOLOR_ARGB(255,165,255,40);
	const DWORD RANK_COLOR_2 = D3DCOLOR_ARGB(255,255,255,45);
	const DWORD RANK_COLOR_3 = D3DCOLOR_ARGB(255,255,500,50);
	const DWORD RANK_COLOR_4 = D3DCOLOR_ARGB(255,255,132,56);
	const DWORD RANK_COLOR_5 = D3DCOLOR_ARGB(255,255,52,45);
	const DWORD RANK_COLOR_6 = D3DCOLOR_ARGB(255,255,12,218);
	const DWORD RANK_COLOR_7 = D3DCOLOR_ARGB(255,176,20,255);
	const DWORD RANK_COLOR_8 = D3DCOLOR_ARGB(255,30,187,255);
	const DWORD RANK_COLOR_9	= D3DCOLOR_ARGB(210,39,207,102);
	const DWORD RANK_COLOR_10	= D3DCOLOR_ARGB(255,255,0,0);
	const DWORD RANK_COLOR_11	= D3DCOLOR_ARGB(255,255,251,198);
	const DWORD RANK_COLOR_12	= D3DCOLOR_ARGB(255,145,247,255);
	const DWORD RANK_COLOR_13	= D3DCOLOR_ARGB(255,145,247,255);
	const DWORD RANK_COLOR_14	= D3DCOLOR_ARGB(255,145,247,255);
	const DWORD RANK_COLOR_15	= D3DCOLOR_ARGB(255,145,247,255);
	const DWORD RANK_COLOR_16	= D3DCOLOR_ARGB(255,145,247,255);
	const DWORD RANK_COLOR_17	= D3DCOLOR_ARGB(255,145,247,255);
	const DWORD RANK_COLOR_18	= D3DCOLOR_ARGB(255,145,247,255);
	const DWORD RANK_COLOR_19	= D3DCOLOR_ARGB(255,145,247,255);
	const DWORD RANK_COLOR_20	= D3DCOLOR_ARGB(255,145,247,255);
};
