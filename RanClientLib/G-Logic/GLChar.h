...
protected:
	/////////////////////////////////////////////////////
	HRESULT MsgReqTopUp (NET_MSG_GENERIC* nmg);

	/////////////////////////////////////////////////
	//  ItemMall
	HRESULT MsgReqUseAutoSkill(NET_MSG_GENERIC* nmg);
	/////////////////////////////////////////////////
	...
	HRESULT	MsgReqLinkSkillEff ( NET_MSG_GENERIC* nmg );//Link Skill Effect by NaJ
	HRESULT	MsgReqTyrannyWin ( NET_MSG_GENERIC* nmg );//Link Skill Effect by NaJ
	...
	HRESULT ReqPointShop( NET_MSG_GENERIC* nmg );		// ItemMIx
	...
	HRESULT MsgReqTyrannyReward ( NET_MSG_GENERIC* nmg );
...
public:
	...
	SNATIVEID	GetLinkSkillID() { return m_sACTIVELINKSKILL; }
	WORD		GetLinkLevel() { return m_wLinkLevel; }
