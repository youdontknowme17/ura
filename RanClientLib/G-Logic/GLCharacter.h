...
public:
	...
	DWORD				m_dwTransfromCHF;					//  소환수 ID
	DWORD				m_dwSummonSkill;					//  소환수 ID
...
private:
	BOOL			m_bAutoSkill;
	void			SetUsingAutoSkillOn()	{ m_bAutoSkill = TRUE; }
	void			SetUsingAutoSkillOff()	{ m_bAutoSkill = FALSE; }
	BOOL			IsUsingAutoSkill()		{ return m_bAutoSkill; }
//////////////////////////////////////////
...
public:
	...
	SINVEN_POS		m_sPointShopPos[POINTSHOP_ITEMNUM];
...
public:
	...
	void ReqGateOut ();
	void ReqGateOutMove ( int i, SNATIVEID sMAPID );
...
public:
	////////////////////////////////////
	HRESULT ReqTopUp(LONGLONG lnSaldo);
	/////////////////////////////////////////////////////
	//  AutoPilot
	HRESULT ReqUseAutoSkill(int nValue);
	BOOL	m_bAPSkillReady;
	BOOL	IsAPSkillReady()		{ return m_bAPSkillReady; }
	/////////////////////////////////////////////////////
...
public: //sealed card 
	...
	HRESULT ReqRebuildResult( SITEMSEALDATA pData1, SITEMSEALDATA pData2, SITEMSEALDATA pData3 );
...
public:
	...
	bool ValidPointShopOpen();
	const SITEMCUSTOM GET_POINT_SHOP( int nIndex );
	void SetPointShopMoveItem( int nIndex );
	void ReSetPointShopItem( int nIndex );
	void ResetPointShop();
	DWORD GetPointShopMoney();

	HRESULT ReqPointShop( DWORD dwNpcID );
...
public:
	...
	void SetStatusPointUp() { m_wStatsPoint++; } // Note : 얗睾間도驥宣逗� 1
	void SetStatusPointDown() { m_wStatsPoint--; } // Note : 얗睾間도驥킴 1
...
protected:
	...
	///////////////////////////////////////
	//  AutoPilot
	void AutoSkillReaction(const STARGETID &sTargetID, const DWORD dwMR, const bool bcontinue, BOOL &bMove, D3DXVECTOR3 &vMoveTo);
	///////////////////////////////////////
...
public:
	...
	void			ReqLinkSkill( SNATIVEID sSKILLID, WORD wLevel );
	HRESULT			ReqSortItem ();
	void			ReqSetTyrannyWin(int nSchool);
protected:
	bool			m_bSkinUpdate;
	bool			m_bCharSet;
public:
