...
enum
{
	...
	//add money 2
	//log money limit for premium
	EMMONEY_LOG_PREMIUM				= 1,
	EMMONEY_LOG_CONTRIBUTION		= 2,
};
...
enum EMITEM_ROUTE
{
	...
	//add money 2
	EMITEM_ROUTE_CHAR_VOTE			= 17,
	EMITEM_ROUTE_DELETE_VOTE		= 18,
	//
	EMITEM_ROUTE_CHAR_PREMIUM		= 19,
	EMITEM_ROUTE_DELETE_PREMIUM		= 20,

	//add point sell
	EMITEM_ROUTE_SHOP_VOTE			= 21,
	EMITEM_ROUTE_SHOP_PREMIUM		= 22,
	//add contributionpoint by CNDev
	EMITEM_ROUTE_CHAR_CONTRIBUTION	= 23,
	EMITEM_ROUTE_DELETE_CONTRIBUTION = 24,

	EMITEM_ROUTE_SHOP_CONTRIBUTION = 25,
	EMITEM_ROUTE_POINTSHOP	= 26,
};
