...
enum EMREQ_RECALL_FB
{
	...
	EMREQ_RECALL_CARD_ITEM		= 8,	//added - Anti SP, BP During War
};
...
namespace GLMSG
{
	...
	struct SNETPC_LAND_INFO
	{
		...
		bool				bSchoolWars;
		bool				bSchoolWarsHall;
		bool				bRoyalRumble;
		bool				bRoyalRumbleHall;
		bool				bTowerWars;
		bool				bPK;

		DWORD				dwGuidClub;
		DWORD				dwSchoolWarWin;
		...
		SNETPC_LAND_INFO () 
			...
			, bSchoolWars(false)
			, bSchoolWarsHall(false)
			, bRoyalRumble(false)
			, bRoyalRumbleHall(false)
