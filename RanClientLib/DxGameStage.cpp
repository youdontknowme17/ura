...
#include "../EngineLib/DxCommon/DxEnvironment.h"
#include "../EngineLib/DxCommon/DxGlowMan.h"
#include "../EngineLib/DxCommon/DxPostProcess.h"
#include "../EngineLib/DxCommon/DxCubeMap.h"
#include "../EngineLib/DxCommon/DxSkyMan.h"
#include "../EngineLib/DxCommon/DxDynamicVB.h"	// 삭제 해야한다.
#include "../EngineLib/DxCommon/DxSurfaceTex.h"
...
#include "../EngineLib/Meshs/DxSkinAniControl.h"
...
HRESULT DxGameStage::Render ()
{
	...
	//add mouse effect
	PROFILE_BEGIN2("DxEffMouseClick::Render");
	DxEffMouseClick::GetInstance().Render ( m_pd3dDevice );
	PROFILE_END2("DxEffMouseClick::Render");

	PROFILE_BEGIN2("DxEffMouseTarget_A::Render");
	DxEffMouseTarget_A::GetInstance().Render ( m_pd3dDevice );
	PROFILE_END2("DxEffMouseTarget_A::Render");

	PROFILE_BEGIN2("DxEffMouseTarget_B::Render");
	DxEffMouseTarget_B::GetInstance().Render ( m_pd3dDevice );
	PROFILE_END2("DxEffMouseTarget_B::Render");
