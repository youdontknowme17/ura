...
#include "../EngineUILib/GUInterface/UIDataType.h"
...
struct GLCHAR_NEWINFO
{
	...
	bool CHECKVALID () const
	{
		...
		//add class
		if ( m_emIndex>=GLCI_NUM_2015 )	return false;
		return true;
	}
...
protected:
	...
	//밌需죠間됴췬 Animation Camera //edit camera
	float				m_fAnimCamX;
	float				m_fAnimCamX_M;
	bool				m_bAnimCamX;
	float				m_fAnimCamY;
...
public:
	...
	DxCharSham			m_pBodyChar;
	DxSkinChar*			m_pSkinCharBody;
	D3DXMATRIX			m_matTransSkinCharBody;
protected:
