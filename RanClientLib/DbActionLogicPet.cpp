...
CSetPetDualSkill::CSetPetDualSkill(int nChaNum, int nPetNum)
		: m_nChaNum(nChaNum),
		m_nPetNum(nPetNum)				
{
...
CSetPetDualSkill::Execute(CServer* pServer)
{
	return m_pDbManager->SetPetDualSkill(m_nChaNum, m_nPetNum);
}
/**
* 팻을 삭제한다.
