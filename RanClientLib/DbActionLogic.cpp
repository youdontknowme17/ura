...
//add sw buff
CSetSwRegion::CSetSwRegion(DWORD dwSwID, DWORD dwSwNum)
{
	m_dwSwID = dwSwID;
	m_dwSwNum = dwSwNum;
}

int CSetSwRegion::Execute(CServer* pServer)
{
	return m_pDbManager->SetSwRegion(m_dwSwID, m_dwSwNum);
}
///////////////////////////////////////////////////////////////////////////
// 해당 지역의 소유 상태를 리셋한다.
...
CUserBlock::CUserBlock(int nUserNum,  int nDay )
{
	m_nUserNum = nUserNum;
	m_nDay = nDay;
}
